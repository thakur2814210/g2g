    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('partner/coupons/display')}}"><i class="fa fa-tablet"></i>{{ trans('labels.ListingAllCoupons') }}</a></li>
                        ...
                        <div class="box-body">
                          ...
                          <h3 class="box-title">Edit category</h3>
                                        ...
                                        <div class="box-body">
                                            ...
                                            {!! Form::open(array('url' =>'partner/coupons/insert', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <h3 class="box-title">{{ trans('labels.AddCoupons') }}</h3>
                                	...
                                	{{ trans('labels.CouponAmountText') }}</span>
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <a href="{{ URL::to('partner/coupons/display')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                            </div>
                                            <!-- /.box-footer -->
                                            {!! Form::close() !!}
                                        </div>
