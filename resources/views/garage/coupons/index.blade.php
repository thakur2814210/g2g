                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="col-lg-6 form-inline" id="contact-form">
                                ...
                                <form  name='registration' id="registration" class="registration" method="get" action="{{url('partner/coupons/filter')}}">
                                    ...
                                    <div class="input-group-form search-panel ">
                                        ...
                                        @if(isset($param,$name))  <a class="btn btn-danger " href="{{url('partner/coupons/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                        {{--</span>--}}
                                    </div>
                                </form>
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('partner/coupons/add')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if($coupons !== null)
                                            @foreach ($coupons as $key=>$coupan)
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.Edit') }}" href="{{ url('partner/coupons/edit')}}/{{$coupan->coupans_id}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="deleteCoupanModal" tabindex="-1" role="dialog" aria-labelledby="deleteCoupanModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'partner/coupons/delete', 'name'=>'deleteCoupan', 'id'=>'deleteCoupan', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
