                    ...
                    <div class="box">
                        <div class="box-header">
                                        ...
                                        <div class="col-lg-6 form-inline">
                                                <form name='filter' id="registration" class="filter  " method="get" action="{{url('admin/manufacturers/filter')}}">
                                                    ...
                                                    <div class="input-group-form search-panel ">
                                                      ...
                                                      @if(isset($param,$name))  <a class="btn btn-danger " href="{{URL::to('partner/manufacturers/display')}}"><i class="fa fa-ban" aria-hidden="true"></i> </a>@endif
                                                    </div>
                                                </form>
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('partner/manufacturers/add') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                        ...
                                        @if(count($manufacturers)>0)
                                            @foreach ($manufacturers  as $key=>$manufacturer)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="{{ URL::to('partner/manufacturers/edit/'.$manufacturer->id)}}" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
            ...
            <div class="modal fade" id="manufacturerModal" tabindex="-1" role="dialog" aria-labelledby="deleteManufacturerModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'partner/manufacturers/delete', 'name'=>'deleteManufacturer', 'id'=>'deleteManufacturer', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
