...
<div class="content-wrapper">
                  ...
                  <tbody>
                   @if (count($result['admins']) > 0)
                    ...
                    @endforeach
                     @if($result['vendor']->balance <= 0)
                      <tr>
                        <td colspan="5"><span class="text-danger">You dont have enough balance in your account to make this withdraw request!</span></td>
                      </tr>
                     @endif
                    @else
                      <tr>
  ...
  <div class="modal fade" id="WithdrawMoneyFormModal" tabindex="-1" role="dialog" aria-labelledby="WithdrawMoneyFormModalLabel">
    ...
    <div class="modal-content">
      ...
      {!! Form::open(array('url' =>'partner/vendor/transactions/withdrawRequest/store', 'name'=>'WithdrawMoneyMethod', 'id'=>'WithdrawMoneyMethod', 'method'=>'post', 'class' => 'form-horizontal')) !!}
