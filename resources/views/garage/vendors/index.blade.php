...
<div class="content-wrapper">
                ...
                <td>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="{{ URL::to('partner/editvendor')}}/{{ $admin->id }}">{{ trans('labels.editvendor') }}</a></li>
  ...
  <div class="modal fade" id="deleteCustomerModal" tabindex="-1" role="dialog" aria-labelledby="deleteCustomerModalLabel">
    ...
    <div class="modal-content">
      ...
      <h4 class="modal-title" id="deleteCustomerModalLabel">{{ trans('labels.deleteVendor') }}</h4>
      </div>
      {!! Form::open(array('url' =>'partner/deletevendor', 'name'=>'deleteAdmin', 'id'=>'deleteAdmin', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
          {!! Form::hidden('action',  'delete', array('class'=>'form-control')) !!}
          { {!! Form::hidden('users_id', '', array('class'=>'form-control', 'id'=>'users_id')) !!}
      <div class="modal-body">
        <p>{{ trans('labels.Are you sure you want to delete this vendor') }}</p>
      </div>
