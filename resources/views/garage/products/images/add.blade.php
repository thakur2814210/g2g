                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        {!! Form::open(array('url' =>'partner/products/images/insertproductimage', 'name'=>'addImageFrom', 'id'=>'addImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
