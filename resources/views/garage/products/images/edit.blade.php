                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        {{--{!! Form::open(array('url' =>'partner/addnewproductimage', 'name'=>'addImageFrom', 'id'=>'addImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}--}}
                                        ...
                                        <div class="modal-body">
                                            ...
                                            {!! Form::open(array('url' =>'partner/products/images/updateproductimage', 'name'=>'editImageFrom', 'id'=>'editImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
