...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::to('partner/products/display') }}">{{ trans('labels.ListingAllProducts') }}</a></li>
            @if($result['products'][0]->products_type==1)
            <li><a href="{{ URL::to('partner/products/attach/attribute/display/'.$result['products'][0]->products_id) }}">{{ trans('labels.AddOptions') }}</a></li>
            @endif
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-info">
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'partner/products/inventory/addnewstock', 'name'=>'inventoryfrom', 'id'=>'addewinventoryfrom', 'method'=>'post', 'class' => 'form-horizontal form-validate',
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="box box-danger">
                                                            ...
                                                            <!-- /.box-header -->
                                                            <div class="box-body">
                                                                {!! Form::open(array('url' =>'partner/products/inventory/addminmax', 'name'=>'addminmax', 'id'=>'addminmax', 'method'=>'post', 'class' => 'form-horizontal form-validate-level',
                                                                'enctype'=>'multipart/form-data')) !!}
                                                                {!! Form::hidden('products_id', $result['products'][0]->products_id, array('class'=>'form-control', 'id'=>'products_id')) !!}
                                            ...
                                            <div class="box-footer col-xs-12">
                                                @if($result['products'][0]->products_type==1)
                                                <a href="{{ URL::to("partner/products/attach/attribute/display/".$result['products'][0]->products_id) }}" class="btn btn-default pull-left">{{ trans('labels.AddOptions') }}</a>
                                                @else
                                                <a href="{{ URL::to("partner/products/display")}}" class="btn btn-default pull-left"> <i class="fa fa-angle-left"></i> {{ trans('labels.back') }}</a>
                                                @endif
                                                <a href="{{ URL::to("partner/products/images/display/{$result['products'][0]->products_id}")}}" class="btn btn-primary pull-right"> {{ trans('labels.Save_And_Continue') }} <i class="fa fa-angle-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
