                                        ...
                                        @if($result['reviews'])
                                            @foreach ($result['reviews'] as $review)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($review->reviews_read == 0 and $review->reviews_status == 0)
                                                      <a class="btn btn-warning" style="width: 100%;  margin-bottom: 5px;" href="{{ URL::to('partner/reviews/edit/'.$review->reviews_id.'/0')}}">{{ trans('labels.pending') }}</a>
                                                      </br>
                                                      @endif
                                                      <a class="btn btn-success" style="width: 100%;  margin-bottom: 5px;"  href="{{ URL::to('partner/reviews/edit/'.$review->reviews_id.'/1')}}">{{ trans('labels.Active') }}</a>
                                                    </br>
                                                    <a class="btn btn-danger" style="width: 100%;  margin-bottom: 5px;"  href="{{ URL::to('partner/reviews/edit/'.$review->reviews_id.'/-1')}}">{{ trans('labels.Deactive') }}</a>
                                                      </td>
                                                </tr>
                                            @endforeach
                                        @else
            ...
            <div class="modal fade" id="deleteLanguagesModal" tabindex="-1" role="dialog" aria-labelledby="deleteLanguagesModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'partner/languages/delete', 'name'=>'deletelanguages', 'id'=>'deletelanguages', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
