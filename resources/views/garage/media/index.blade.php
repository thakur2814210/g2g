                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        @if( count($errors) > 0)
                                            ...
                                            {!! Form::open(array('url' =>'partner/media/updatemediasetting', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        ...
                                        <div class="box-footer text-center">
                                            ...
                                            <a href="{{ route('garage.dashboard')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                                        </div>
