                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <div class="box-tools pull-right">
                                <a href="{{ URL::to('partner/products/attributes/add')}}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddNew') }}</a>
                            </div>
                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td dir="ltr">
                                                        @foreach($data->data as $language)
                                                            ...
                                                            @endif
                                                        @endforeach
                                                        <a href="{{ URL::to('partner/products/attributes/edit')}}/{{$data->products_options_id}}" >{{ trans('labels.Manage Options') }}</a><br>
                                                    </td>
                                                    <td dir="ltr">
                                                        @foreach($data->data as $language)
                                                            <strong>{{$language->name}}:</strong>
                                                            ...
                                                            <br>
                                                        @endforeach
                                                        <a href="{{ URL::to('partner/products/attributes/options/values/display')}}/{{$data->products_options_id}}" >{{ trans('labels.Manage Values') }}</a><br>
                                                    </td>
            ...
            <div class="modal fade" id="deleteattributeModal" tabindex="-1" role="dialog" aria-labelledby="deleteAttributeModalLabel">
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-content">
                        ...
                        {!! Form::open(array('url' =>'partner/products/attributes/delete', 'name'=>'deleteAttribute', 'id'=>'deleteAttribute', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
