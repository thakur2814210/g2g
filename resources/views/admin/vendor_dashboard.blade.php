            ...
            <div class="row">
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-yellow">
                    <div class="inner">
                      <h3>{{ $counts['c_clientPackageSubscribe'] }}</h3>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-blue">
                    <div class="inner">
                      <h3>{{ $counts['c_garagePackageSubscribe'] }}</h3>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    ...
                    <a href="{{ URL::to('admin/transactions/withdrawLog')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.WithdrawLog') }}">{{ trans('labels.WithdrawLog') }} <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
