            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/transactions/withdrawMethod/store', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                           
                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Method Name') }} </label>
                                <div class="col-sm-10 col-md-4">
                                  {!! Form::text('methodName',  '', array('class'=>'form-control field-validate', 'id'=>'methodName')) !!}
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                  {!! Form::number('processTime',  '', array('class'=>'form-control field-validate', 'id'=>'processTime')) !!}
                            ...
                            <hr> 
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::number('minimum',  '', array('class'=>'form-control field-validate', 'id'=>'minimum')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::number('maximum',  '', array('class'=>'form-control field-validate', 'id'=>'maximum')) !!}
                            ...
                            <hr>
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('charged',  '', array('class'=>'form-control field-validate', 'id'=>'charged')) !!}
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    {!! Form::text('chargep',  '', array('class'=>'form-control field-validate', 'id'=>'chargep')) !!}
