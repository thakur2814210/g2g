                         ...
                         <div class="box-body">
                          ...
                          @if(Auth()->user()->role_id === 1)
                            ...
                            <table class="table table-bordered table-striped">
                              ...
                              <div class="col-md-6">{!! Form::open(array('url' =>'admin/transactions/withdrawLog/message/store', 'method'=>'post', 'class' => 'form-horizontal form-validate')) !!}
                            ...
                            <hr> 
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/transactions/withdrawLog')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}</div>
                            </div>
