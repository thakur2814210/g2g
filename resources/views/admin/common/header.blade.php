...
<header class="main-header">
    ...
    <a href="{{ URL::to('admin/dashboard/this_month')}}" class="logo">
      ...
      @if(Auth()->user()->role_id != 3)
        <span class="logo-mini" style="font-size:12px"><b>{{ trans('labels.AdminDashboard') }}</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>{{ trans('labels.AdminDashboard') }}</b></span>
      @else
        <span class="logo-mini" style="font-size:12px"><b>{{ trans('labels.VendorDashboard') }}</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>{{ trans('labels.VendorDashboard') }}</b></span>
      @endif
    </a>
