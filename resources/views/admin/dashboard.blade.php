            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-green">
                    ...
                    <a href="{{ URL::to('administrator/garage/active/list')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Garages">View All Garages <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    ...
                    <a href="{{ URL::to('admin/products/display')}}" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="{{ trans('labels.TotalSalesAmount') }}">{{ trans('labels.viewAllProducts') }} <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
