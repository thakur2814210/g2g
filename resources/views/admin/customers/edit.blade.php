                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.Email') }}* </label>
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text('email', $data['customers']->email, array('class'=>'form-control field-validate', 'id'=>'first_name' , 'readonly' => 'readonly')) !!}
                                            </div>
                                        </div>
