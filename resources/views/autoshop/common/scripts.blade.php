    ...
    headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
		...
		success: function (res) {
			if(res.status == 'exceed'){
				...
				swal("@lang('website.Congrats!')", "@lang('website.Product Added Successfully Thanks.Continue Shopping')", "success");
 ...
 jQuery.ajax({
	 ...
	 success: function (res) {
		 if(res['status'] == 'exceed'){
			 ...
			 jQuery('.head-cart-content').html(res);
			 jQuery(parent).addClass('active');
			 swal("@lang('website.Congrats!')", "@lang('website.Product Added Successfully Thanks.Continue Shopping')", "success",{button: false});
