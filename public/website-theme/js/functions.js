(function ($) {
	...
	$('.utf_testimonial_carousel').owlCarousel({
		center: true,
		items: 1,
		loop: true,
		margin: 50,
	...
	$( ".toogle-distance-slider" ).click(function() {
        $(".distance-slider").slideToggle();
    });
	
	$('#thedistance').on("change keyup paste", function(){
