			...
			<div class="row justify-content-center margin_60_35">
				...
				<div class="col-xl-5 col-lg-6 pr-xl-5">
					<div class="main_title_3">
						...
						<p><?php echo app('translator')->get('website::default.send_us_message_text'); ?></p>
					</div>
				...
				<?php if($contactusinfos->count()): ?>
					...
					<div class="col-xl-5 col-lg-6 pl-xl-5">
						...
						<div class="box_contacts">
							...
							<a href="tel:<?php echo e($contactusinfo->phone); ?>"><?php echo e($contactusinfo->phone); ?></a>
						</div>
						<div class="box_contacts">
							<i class="ti-home"></i>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website::layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devhs/public_html/g2g-v3/Modules/Website/Resources/views/pages/contact-us.blade.php ENDPATH**/ ?>