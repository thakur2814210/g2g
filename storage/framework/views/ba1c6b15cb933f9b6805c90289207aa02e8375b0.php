                        ...
                        <div class="box box-info">
                          ...
                          <div class="row">
                            ...
                            <div class="box-body">Add Service Package Feature
                              <form class="form-horizontal" method="POST" action="<?php echo e(route('superadmin.service-package.features.save')); ?>" enctype="multipart/form-data">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/Modules/Admin/Resources/views/servicepackage/package-featutre-add.blade.php ENDPATH**/ ?>