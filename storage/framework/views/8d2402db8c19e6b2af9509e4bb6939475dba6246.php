...
<div class="login-box">
  <div class="login-logo">
    ...
    <div style="
    font-size: 25px;
"><b> <?php echo e(trans('labels.welcome_message')); ?></b><?php echo e(trans('labels.vendor_welcome_message_to')); ?></div>
  </div>
  <!-- /.login-logo -->
...
<?php echo $__env->make('admin.layoutLlogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/admin/vendor_login.blade.php ENDPATH**/ ?>