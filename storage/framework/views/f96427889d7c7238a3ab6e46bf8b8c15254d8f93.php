								...
								<td style="border:0;margin:0;padding:10px;font-family:Arial,Helvetica,sans-serif;font-size:12px">
									...
									<table border="0" cellspacing="0" cellpadding="0" width="100%" style="color:#000000;background:#ffffff;min-width:450px;border:none;border-collapse:collapse;table-layout:fixed;text-align:left;padding:0;margin:0;font-family:Arial,Helvetica,sans-serif;font-size:12px">
										...
										<tbody>
											...
											<tr style="padding:0;margin:0;border:0">
												<td colspan="2" style="padding:0 0 8px 0;margin:0;border:0;vertical-align:top">
													<div style="font-size:18px;color:#333333">You have accepted the quoute amount by the garage for this service request.</div>
												</td>
											</tr>
											<?php endif; ?>
											<tr style="padding:0;margin:0;border:0">
											...
											<tr style="padding:0;margin:0;border:0">
												<td style="padding:3px 0 0 0;margin:0;border:0"><?php echo e('Customer Email'); ?>:</td>
												<td style="padding:3px 0 0 0;margin:0;border:0">
												    <span><?php echo e($data->client_email); ?></span>
												</td>
											</tr>
											<tr style="padding:0;margin:0;border:0">
												<td style="padding:3px 0 0 0;margin:0;border:0"><?php echo e('Customer Phone'); ?>:</td>
												<td style="padding:3px 0 0 0;margin:0;border:0">
												    <span><?php echo e($data->client_phone); ?></span>
												</td>
											</tr>
...
</div><?php /**PATH /home/g2g/public_html/resources/views//mail/service-request/create/customer.blade.php ENDPATH**/ ?>