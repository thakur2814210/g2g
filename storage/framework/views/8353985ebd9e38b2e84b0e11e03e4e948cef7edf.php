                    ...
                    <?php if(!empty($subscriptions) && count($subscriptions) > 0): ?>
                      <?php $__currentLoopData = $subscriptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subscription): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($subscription->garage->name); ?></td>
                            ...
                            <td>
                               <a class="btn btn-sm btn-outline-danger "  href="<?php echo e(route('superadmin.subscriptions.clients.settings',['id' => $subscription->id])); ?>">
                                  Update
                                </a>
                                &nbsp;
                                <a  class="btn btn-sm btn-outline-danger" href="<?php echo e(route('superadmin.subscriptions.clients.logs',['id' => $subscription->id])); ?>">
                                  Logs
                                </a>
                            </td>
                        </tr>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/Modules/Admin/Resources/views/subscription/customer_list.blade.php ENDPATH**/ ?>