                        ...
                        <div class="box-header">
                           ...
                           <div class="col-lg-10 form-inline">
                            ...
                            <div class="box-tools pull-right">
                                <a href="<?php echo e(URL::to('vendor/product/add')); ?>" type="button" class="btn btn-block btn-primary"><?php echo e(trans('labels.AddNew')); ?></a>
                            </div>
                            </div>
                        </div>
                        <!-- /.box-header -->
...
<?php echo $__env->make('vendor.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/vendor/products/index.blade.php ENDPATH**/ ?>