<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
            <?php echo e(trans('labels.breadcrumb_dashboard')); ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-green">
                    <div class="inner">
                      <h3># <?php echo e($counts['garage']); ?></h3>
                            <p>Total Garages</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-home"></i>
                    </div>
                    <a href="<?php echo e(URL::to('administrator/garages/active/list')); ?>" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="View All Garages">View All Garages <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    ...
                    <a href="<?php echo e(URL::to('admin/products/display')); ?>" class="small-box-footer" data-toggle="tooltip" data-placement="bottom" title="<?php echo e(trans('labels.TotalSalesAmount')); ?>"><?php echo e(trans('labels.viewAllProducts')); ?> <i class="fa fa-arrow-circle-right"></i></a>
                  </div>
                </div>
                <!-- ./col -->
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>