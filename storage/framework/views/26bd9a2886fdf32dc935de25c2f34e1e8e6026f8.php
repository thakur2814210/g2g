                ...
                <tr class="d-flex">
                  ...
                  <td class="col-12 col-md-4 item-detail-left">
                    <div class="item-detail">
                        <h4><a href="<?php echo e(URL::to('/product-detail/'.$products->products_slug)); ?>"><?php echo e($products->products_name); ?></a>
                          <br>
                        </h4>
                    ...
                    <td class="col-12 col-md-10 d-none d-md-block">
                        ...
                        <?php $__currentLoopData = $other_charges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $oc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($oc->categories_id == $products->categories_id): ?>
                                ...
                                <input type="checkbox" id="<?php echo e('oc_'.$index.'_'.$oc->id.'_'.$products->customers_basket_id); ?>"  <?php if($oc->is_checked == 1): ?> checked <?php endif; ?>
                                ...
                                <?php if($oc->is_percentage == 1): ?>
                                     <?php if($oc->changes_on_total == 1): ?>
                                         <?php echo e('+ AED '. $oc->amount. '%'); ?> 
                                     <?php elseif($oc->changes_on_total == 2): ?>
                                         <?php echo e('- AED '. $oc->amount. '%'); ?> 
                                     <?php else: ?>
                                         <?php echo e('AED'. $oc->amount. '%'); ?>  (<small color="danger"><?php echo app('translator')->get('website.Only this price is applicable and Product price will be zero'); ?></small>)
                                     <?php endif; ?>
                                <?php else: ?>
                                     <?php if($oc->changes_on_total == 1): ?>
                                        <?php echo e('+ AED ' .$oc->amount); ?> 
              ...
              <div class="row justify-content-between click-btn">
                <div class="col-12 col-lg-4">
                  <form id="apply_coupon" class="form-validate">
                    <div class="row">
                        <div class="input-group">
                            <input type="text" name="coupon_code" class="form-control" id="coupon_code" placeholder="<?php echo app('translator')->get('website.Coupon Code'); ?>" aria-label="<?php echo app('translator')->get('website.Coupon Code'); ?>" aria-describedby="coupon-code">

                            <div class="">
                              <button class="btn btn-secondary" type="submit" id="coupon-code"><?php echo app('translator')->get('website.APPLY'); ?></button>
                            </div>
                          </div>
                    </div>
                 </form>
...
<?php /**PATH /home/g2g/public_html/resources/views/autoshop/carts/cart1.blade.php ENDPATH**/ ?>