          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(route('garage.profile.view')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('labels.profile_link')); ?></a>
                </div>
                <div class="pull-right">
                    <a href="<?php echo e(route('garage.logout')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('labels.sign_out')); ?></a>
                </div>
              </li>
            </ul>
          </li>
...
<?php /**PATH D:\xampp74\htdocs\g2g\resources\views/garage/common/header.blade.php ENDPATH**/ ?>