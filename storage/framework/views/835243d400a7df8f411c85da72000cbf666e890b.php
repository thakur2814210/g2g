         ...
         <div class="col-12 col-lg-3  d-lg-block d-xl-block right-menu">
           ...
           <form enctype="multipart/form-data" name="filters" id="test" method="get">
             ...
             <div class="range-slider-main">
              <h2><?php echo app('translator')->get('website.Part No'); ?></h2>
               <div class="wrapper">
                  <input type="text" class="form-control" name="part_no" id="part_no" >
                </div>
                <br/>
                <h2><?php echo app('translator')->get('website.Manufacture'); ?></h2>
                <div class="select-control">
                    <select class="form-control" id="manufacturer" name="manufacturer">
                      <option value="0" selected><?php echo app('translator')->get('website.None'); ?></option>
                      <?php $__currentLoopData = $result['manufacturers']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $manufacturer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($manufacturer->manufacturers_id); ?>"><?php echo e($manufacturer->manufacturer_name); ?></option>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                  </div>
              </div>
...
<?php /**PATH /home/g2g/public_html/resources/views/autoshop/shop-pages/shop1.blade.php ENDPATH**/ ?>