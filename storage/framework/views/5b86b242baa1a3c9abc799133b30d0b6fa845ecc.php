	...
	<nav aria-label="breadcrumb">
		<div class="container">
			<ol class="breadcrumb">
			  ...
			  <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('website.CustomerLogin'); ?></li>
...
<section class="page-area pro-content">
  ...
  </section><?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/auth/logins/login2.blade.php ENDPATH**/ ?>