                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                      ...
                      <?php elseif(auth()->guard('vendor')->check()): ?>
                        <li class="nav-item"> <a href="<?php echo e(URL::to('/vendor/dashboard')); ?>" class="nav-link"><?php echo app('translator')->get('website.dashboard'); ?></a> </li>

                         <li class="nav-item"> <a href="<?php echo e(URL::to('/vendor/profile')); ?>" class="nav-link"><?php echo app('translator')->get('website.Profile'); ?></a> </li>
...
<?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/autoshop/headers/headerOne.blade.php ENDPATH**/ ?>