                        ...
                        <div class="box box-info">
                          ...
                          <div class="row">
                            ...
                            <div class="box-body">
                              ...
                              <form class="form-horizontal" method="POST" action="<?php echo e(route('superadmin.garage.services.update')); ?>"  enctype="multipart/form-data">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Admin_bk/Resources/views/garage/garage_services.blade.php ENDPATH**/ ?>