                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3">
                  ...
                  <div class="product">
                      <article>
                        <div class="module">
                          <div class="cat-thumb">
							<a href="<?php echo e(URL::to('/shop?category='.$categories_data->slug)); ?>" class="">
...
<?php endif; ?>
<?php /**PATH /home/g2g/public_html/resources/views/autoshop/product-sections/categories.blade.php ENDPATH**/ ?>