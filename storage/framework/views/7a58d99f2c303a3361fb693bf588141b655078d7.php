               ...
               <div id="accordion">
                  ...
                  <div class="card">
                    <div class="card-header card-link">
                      ...
                      <label>
                        <strong class="text-danger">Uername:</strong> <?php echo e(Auth::user()->username); ?>
                            ...
                            <?php $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                             <div class="card flex-row flex-wrap">
                                  ...
                                  <div class="card-block px-2">
                                      ...
                                      <small> 
                                          <b> Make:</b> <?php echo e($vehicle->vmake->name); ?>

                                      </small>
                                      <small> 
                                          <b> Model #:</b> <?php echo e($vehicle->vmodel->name); ?>
                  ...
                  <div class="card">
                    ...
                    <div id="Location" class="collapse" data-parent="#accordion">
                      ...
                      <div class="card-body">
                        ...
                        <div class="card flex-row flex-wrap">
                            <div class="card-header border-0">
                               <input type="radio"  name="your_location" data-lat="<?php echo e($client->latitude); ?>" data-long="<?php echo e($client->longitude); ?>" data-city="<?php echo e($client->city); ?>" data-country="<?php echo e($client->country); ?>" data-address="<?php echo e($client->address); ?>" data-pobox="<?php echo e($client->postal); ?>" value="999" />
                            </div>
                            <div class="card-block px-2">
                                <h6 style="margin: 0px;" class="card-title m-0 text-danger"><?php echo e($client->address); ?></h6>
                                <small> 
                                    <b> City:</b> <?php echo e($client->t_city->name); ?>

                                </small>
                                <small> 
                                    <b> Country #:</b> <?php echo e($client->t_country->name); ?>

                                </small>
                                <small> 
                                    <b> Pobox:</b> <?php echo e($client->postal); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website::layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devhs/public_html/g2g-v3/Modules/Client/Resources/views/service-request/create-service-request.blade.php ENDPATH**/ ?>