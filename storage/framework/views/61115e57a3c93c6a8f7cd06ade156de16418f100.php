					...
					<div class="card">
			          <div class="card-header p-0 text-center" style="padding:0px;">
			            <ul class="nav nav-tabs" id="pills-tab" role="tablist">
						  <li class="nav-item">
						    <a class="nav-link active" id="pills-signin-tab" data-toggle="pill" href="#pills-signin" role="tab" aria-controls="pills-signin" aria-selected="true"><i class="fa fas fa-sign-in"></i>  <?php echo app('translator')->get('website::default.customer'); ?> <?php echo app('translator')->get('website::default.sign_in'); ?></a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" id="pills-register-tab" data-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false"><i class="fa fas fa-registered"></i>  <?php echo app('translator')->get('website::default.customer'); ?> <?php echo app('translator')->get('website::default.register'); ?></a>
						  </li>
						</ul>
			          </div>
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade show active" id="pills-signin" role="tabpanel" aria-labelledby="pills-signin-tab">
								...
								<div class="box_account">
									...
									<form action="<?php echo e(route('client.authenticate')); ?>" method="post">
							...
							<div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
								<div class="box_account">
									...
									<div class="form_container">
										...
										<form action="<?php echo e(route('client.register')); ?>" method="post">
											<?php echo e(csrf_field()); ?>
											...
											<div class="row ">
												...
												<div class="col-9">
													<div class="form-group">
														<input type="number" class="form-control" name="phone" id="phone"  min="8" value="" placeholder="* <?php echo app('translator')->get('website::default.enter_phone'); ?>" value="<?php echo e(Request::old('phone')); ?>" required="">
													</div>
												</div>
											</div>

											<div class="form-group">
												<input type="text" class="form-control" name="first_name" id="first_name" value="" placeholder="* <?php echo app('translator')->get('website::default.first_name'); ?>" value="<?php echo e(Request::old('first_name')); ?>" required="">
											</div>

											<div class="form-group">
												<input type="text" class="form-control" name="last_name" id="last_name" value="" placeholder="* <?php echo app('translator')->get('website::default.last_name'); ?>" value="<?php echo e(Request::old('last_name')); ?>" required="">
											</div>
											...
											<div class="form-group">
												<label class="container_check"><?php echo app('translator')->get('website::default.accept'); ?> <a href="#0"><?php echo app('translator')->get('website::default.terms_and_conditions'); ?></a>
													<input type="checkbox">
													<span class="checkmark"></span>
												</label>
											</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website::layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devhs/public_html/g2g-v3/Modules/Website/Resources/views/auth/client.blade.php ENDPATH**/ ?>