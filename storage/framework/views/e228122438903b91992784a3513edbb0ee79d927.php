     ...
     <div class="row">
       ...
       <div class="card">
        <div class="card-header">
         <?php echo app('translator')->get('website.Package Subscription'); ?> <?php echo app('translator')->get('website.Log'); ?> : <?php echo e($clientPackageSubscribe->servicePackage->name); ?>
          ...
          <div class="card-body table-responsive">
            <table class="table table-head-fixed table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
              <thead>
                  ...
                  <th><?php echo app('translator')->get('website.Descriptions'); ?></th>
                </tr>
              </thead>
              <tfoot>
                 <tr style="background: #e9ecef">
...
<?php echo $__env->make('autoshop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/resources/views/autoshop/package/logs.blade.php ENDPATH**/ ?>