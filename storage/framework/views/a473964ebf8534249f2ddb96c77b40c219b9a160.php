	...
	<nav aria-label="breadcrumb">
		<div class="container">
			<ol class="breadcrumb">
			  ...
			  <li class="breadcrumb-item active" aria-current="page"><?php echo app('translator')->get('website.GarageLogin'); ?></li>
				...
				<ul class="nav nav-tabs" id="registerTab" role="tablist">
				  ...
				  <div class="tab-content" id="registerTabContent">
					<div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="login-tab">
						...
						<form  enctype="multipart/form-data"   action="<?php echo e(URL::to('garage/authenticate')); ?>" method="post">
...
<?php echo $__env->make('website.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/auth/garage_login.blade.php ENDPATH**/ ?>