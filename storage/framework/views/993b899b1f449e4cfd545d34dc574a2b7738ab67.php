                              ...
                              <form class="form-horizontal" method="POST" action="<?php echo e(route('superadmin.garage.update')); ?>"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                   ...
                                   <div class="box box-solid box-primary">
                                    <div class="box-header">
                                        <i class="fa fa-user-circle" ></i>  Garage details
                                    </div>
                                    <div class="box-body">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/Modules/Admin/Resources/views/garage/garage_details.blade.php ENDPATH**/ ?>