                                    ...
                                    <div class="box-body">
                                      ...
                                      <div class="col-md-12">
                                          ...
                                          <select class="form-control" name="garage_vendor_type" id="garage_vendor_type">
                                            ...
                                            <option value="1" <?php if($garage->type == 1): ?> selected <?php endif; ?>>Garage Only</option>
                                            <option value="2" <?php if($garage->type == 2): ?> selected <?php endif; ?>>Shop Vendor Only</option>
                                             <option value="3" <?php if($garage->type == 3): ?> selected <?php endif; ?>>Both</option>
                                          </select>
                                        </div>
                                    </div>
                                    <br/>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Admin_bk/Resources/views/garage/garage_details.blade.php ENDPATH**/ ?>