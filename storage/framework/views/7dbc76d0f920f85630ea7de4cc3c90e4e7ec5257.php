                          ...
                          <td>
                            ...
                            <?php endif; ?>
                            	<?php echo e($admin->status); ?></strong>
          								...
          								<td>
                              <a href="<?php echo e(URL::to('admin/transactions/withdrawLog')); ?>/<?php echo e($admin->id); ?>" type="button" class="btn btn-sm btn-primary" target="_blank" ><?php echo e(trans('labels.Details')); ?></a>
          								</td>
          							</tr>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/admin/withdraw/PendingRequests.blade.php ENDPATH**/ ?>