...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo e(URL::to('vendor/dashboard/this_month')); ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini" style="font-size:12px"><b><?php echo e(trans('labels.admin')); ?></b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b><?php echo e(trans('labels.vendor')); ?></b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <?php $__currentLoopData = $unseenOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unseenOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li><!-- start message -->
                    <a href="<?php echo e(URL::to("vendor/viewOrder")); ?>/<?php echo e($unseenOrder->orders_id); ?>">
                      <h4>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><b><?php echo e(trans('labels.shop')); ?>:</b> <?php echo e(auth()->guard('vendor')->user()->shop_name); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <b><?php echo e(trans('labels.shop')); ?>:</b> <?php echo e(auth()->guard('vendor')->user()->shop_name); ?>

                  <small><?php echo e(trans('labels.vendor')); ?></small>
                </p>
              </li>
              <!-- Menu Footer-->
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo e(URL::to('vendor/account/profile')); ?>" class="btn btn-default btn-flat"><?php echo e(trans('labels.profile_link')); ?></a>
                </div>
...
<?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/vendor/common/header.blade.php ENDPATH**/ ?>