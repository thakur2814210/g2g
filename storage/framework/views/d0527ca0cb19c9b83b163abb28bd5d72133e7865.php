                  ...
                  <div class="col-lg-4">
                      <div class="card mb-5 mb-lg-0">
                            ...
                            <div class="card-header text-center text-uppercase text-danger">
                               <?php echo e($package->section->name); ?> <?php echo e(trans('website.Package')); ?>
                          ...
                          <h6 class="text-center p-0"> <?php echo e('AED '. $package->price); ?> | (<span class="period"><?php echo e($package->period); ?> <?php echo e(trans('website.Days')); ?></span>)</h6>
                            ...
                            <ul class="fa-ul">
                               <?php $__currentLoopData = $package->packageFeatures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $features): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                  ...
                                  <li>
                                      <label><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> <?php if(\Config::get('app.locale') == 'en'): ?> <?php echo e($features->feature_name); ?> <?php else: ?> <?php echo e($features->feature_name_ar); ?> <?php endif; ?></label>
                                      <br/>
                                      <?php $__currentLoopData = $pf_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php echo e($val); ?>
                            ...
                            <div class="text-center p-1">
                              ...
                              <?php elseif(Auth::guard('customer')->check() || Auth::guard('admin')->check()): ?>
                                <a href="#error-in-dialog"  class="login error-in-modal btn btn-danger btn-block text-uppercase" ><?php echo app('translator')->get('website.select'); ?> sasa</a>
                              <?php else: ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/resources/views/website/package-price.blade.php ENDPATH**/ ?>