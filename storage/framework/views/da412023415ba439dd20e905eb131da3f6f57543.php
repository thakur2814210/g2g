<?php $qunatity=0; ?>
                ...
                <a href="" id="dropdownCartButton_9" class="dropdown-toggle cart-down" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <?php if(count($result['commonContent']['cart'])>0): ?>
                      <span class="badge badge-secondary"><?php echo e(count($result['commonContent']['cart'])); ?>&nbsp;<?php echo app('translator')->get('website.items'); ?></span>
                  <?php else: ?>
...
<?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/autoshop/headers/cartButtons/cartButton9.blade.php ENDPATH**/ ?>