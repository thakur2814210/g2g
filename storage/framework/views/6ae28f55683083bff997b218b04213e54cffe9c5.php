                      ...
                      <div class="card mb-5 mb-lg-0">
                        ...
                        <div class="card-body">
                          ...
                          <ul class="text-center">
                            ...
                            <li>
                              <?php if(Auth::guard('client')->check()): ?>
                                  <a href="<?php echo e(route('client.package-subscription.create',['category' => $package->section->slug])); ?>" class="btn btn-danger btn-block text-uppercase">Select</a>
                              <?php elseif(Auth::guard('admin')->check() || Auth::guard('garage')->check()): ?>
                                <a href="#error-in-dialog"  class="login error-in-modal btn btn-danger btn-block text-uppercase" >Select</a>
                              <?php else: ?>
                                <a href="#sign-in-dialog" data-slug="<?php echo e($package->section->slug); ?>" data-page="client-package-subscription" class="login sign-in-modal btn btn-danger btn-block text-uppercase" >Select</a>
                              <?php endif; ?>
                            </li>
                          </ul>
                        </div>
                            ...
                            <ul class="text-center p-1">
                             <li>
                              <?php if(Auth::guard('garage')->check()): ?>
                                  <a href="<?php echo e(route('garage.packages.buy_or_upgrade',['slug' => $package->slug ])); ?>" class="btn btn-danger btn-block text-uppercase">Select</a>
                              <?php elseif(Auth::guard('client')->check() || Auth::guard('admin')->check()): ?>
                                <a href="#error-in-dialog"  class="login error-in-modal btn btn-danger btn-block text-uppercase" >Select</a>
                              <?php else: ?>
                                <a href="#sign-in-dialog" data-slug="<?php echo e($package->slug); ?>" data-page="garage-package-subscription" class="login sign-in-modal btn btn-danger btn-block text-uppercase" >Select</a>
                              <?php endif; ?>
                            </li>
                            </ul>
                          </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('website::layouts.page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devhs/public_html/g2g-v3/Modules/Website/Resources/views/pages/package-price.blade.php ENDPATH**/ ?>