<div id="filters_col">
	<form id="filterForm" method="get" action="<?php echo e(route('listings.search')); ?>">
		...
		<div class="filter_type">
			<button type="submit" class="btn btn-sm  btn-success"><i class="fa fa-check-circle"></i> <?php echo e(trans('website.Apply')); ?></button>
			<button type="reset" class="btn btn-sm btn-danger float-right"><i class="fa fa-times"></i> <?php echo e(trans('website.Reset')); ?></button>

		</div>
		<br/>

		<a data-toggle="collapse" href="#collapseFilters" aria-expanded="false" aria-controls="collapseFilters" id="filters_col_bt"><?php echo e(trans('website.Filters')); ?> </a>
		<div class="collapse show" id="collapseFilters">
			<div class="filter_type">
	            <h6><?php echo e(trans('website.Distance')); ?></h6>
				  ...
				  <br/>
				  <p><?php echo e(trans('website.Value')); ?>: <span id="distance_filter_range_value"></span> <?php echo e(trans('website.KM')); ?><br/>
					 <small><?php echo e(trans('website.Please select atleast one city to enable distance range')); ?>.</small>
				  </p>
			...
			<div class="filter_type">
				<h6><?php echo e(trans('website.City')); ?></h6>
				<ul>
					<li>
						<label class="container_check"><?php echo e(trans('website.All')); ?>
			...
			<div class="filter_type">
				<h6><?php echo e(trans('website.Category')); ?></h6>
				<ul>
					<li>
						<label class="container_check"><?php echo e(trans('website.All')); ?>
...
</div><?php /**PATH /home/g2g/public_html/resources/views/website/garages/common/leftSidebar.blade.php ENDPATH**/ ?>