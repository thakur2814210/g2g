<header class="header_in is_sticky">
	            	...
	            	<li><span>
						...
						<ul>
			                ...
			                <?php elseif(Auth::guard('vendor')->check()): ?>
			                    <li><a href="<?php echo e(route('garage.dashboard')); ?>" >Garage: <?php echo e(Auth::guard('vendor')->user()->username); ?></a></li>
    ...
    <!-- /header --><?php /**PATH /home/g2g/public_html/Modules/Website/Resources/views/include/home-header.blade.php ENDPATH**/ ?>