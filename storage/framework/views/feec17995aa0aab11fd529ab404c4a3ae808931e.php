...
<?php $__env->startSection('breadcrumb'); ?>
     <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Delete Garage List</li>
    </ol>
<?php $__env->stopSection(); ?>
          ...
          <?php endif; ?>
              ...
              <div class="box_general padding_bottom">
                <div class="header_box version_2">
                  <h2  class="text-danger"><i class="fa fa-users text-danger"></i> Delete Garage List</h2>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/Modules/Admin/Resources/views/garage/garage-delete-list.blade.php ENDPATH**/ ?>