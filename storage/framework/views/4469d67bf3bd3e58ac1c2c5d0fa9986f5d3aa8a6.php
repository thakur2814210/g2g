    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->manage_admins_view == 1): ?>
         ...
         <li class="treeview <?php echo e(Request::is('administrator/garages/active/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/garages/pending/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/garages/delete/list') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-users" aria-hidden="true"></i>
            <span>Manage Garages</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('admin/vendors/active') ? 'active' : ''); ?> <?php echo e(Request::is('admin/updatevendor') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editvendor/*') ? 'active' : ''); ?>">
              <a href="<?php echo e(route('superadmin.garages.active')); ?>">
                <i class="fa fa-circle-o"></i> Active Garages
              </a>
            </li>

            <li class="<?php echo e(Request::is('admin/vendors/pending') ? 'active' : ''); ?> ">
              <a href="<?php echo e(route('superadmin.garages.pending')); ?>">
                <i class="fa fa-circle-o"></i> Pending Garages
              </a>
            </li>

            <li class="<?php echo e(Request::is('admin/vendors/inactive') ? 'active' : ''); ?> ">
              <a href="<?php echo e(route('superadmin.garages.delete')); ?>">
                <i class="fa fa-circle-o"></i> Delete Garages
              </a>
            </li>
      ...
      <?php if( $result['commonContent']['roles'] != null and $result['commonContent']['roles']->language_view == 1): ?>
       ...
       <!-- Vehicles List -->
        <li class="treeview <?php echo e(Request::is('administrator/vehicles/*') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-car"></i> <span><?php echo e(trans('labels.manage_vehicle')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="treeview <?php echo e(Request::is('administrator/vehicles/vehicle-ma*') ? 'active' : ''); ?> ">
                <a href="<?php echo e(url('administrator/vehicles/vehicle-make')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.vehicle_make')); ?> </span>
                </a>
            </li>

            <li class="treeview <?php echo e(Request::is('administrator/vehicles/vehicle-mo*') ? 'active' : ''); ?>">
                <a href="<?php echo e(url('administrator/vehicles/vehicle-modal')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.vehicle_model')); ?> </span>
                </a>
            </li>
          </ul>
        </li>
        ...
        <!-- Section List -->
        <li class="treeview <?php echo e(Request::is('administrator/sections/*') ? 'active' : ''); ?>  <?php echo e(Request::is('administrator/subsections/*') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-list"></i> <span><?php echo e(trans('labels.Manage Sections')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="treeview <?php echo e(Request::is('administrator/sections/list') ? 'active' : ''); ?> ">
                <a href="<?php echo e(url('administrator/sections/list')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.Sections List')); ?> </span>
                </a>
            </li>

            <li class="treeview <?php echo e(Request::is('administrator/subsections/list') ? 'active' : ''); ?>">
                <a href="<?php echo e(url('administrator/subsections/list')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.Sub Sections List')); ?> </span>
                </a>
            </li>
          </ul>
        </li>
        ...
        <li class="treeview <?php echo e(Request::is('administrator/service-package/*') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-tags"></i> <span><?php echo e(trans('labels.Manage Package')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="treeview <?php echo e(Request::is('administrator/service-package/*') ? 'active' : ''); ?> ">
                <a href="<?php echo e(route('superadmin.service-package')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.Package List')); ?> </span>
                </a>
            </li>

            <li class="treeview <?php echo e(Request::is('administrator/service-package/*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.service-package.features')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span> <?php echo e(trans('labels.Package Feature')); ?> </span>
                </a>
            </li>
          </ul>
        </li>

        <li class="treeview <?php echo e(Request::is('administrator/service-request/*') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('superadmin.service-requests')); ?>">
            <i class="fa fa-dashboard"></i> <span><?php echo e(trans('labels.manage_servive_request')); ?></span>
          </a>
        </li>

        <li class="treeview <?php echo e(Request::is('administrator/subscriptions/customers/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/garages/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/customers/settings/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/garages/settings/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/garages/logs/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/customers/logs/*') ? 'active' : ''); ?>">
          <a href="#">
            <i class="fa fa-tags"></i> <span>Package Subscription</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li class="treeview <?php echo e(Request::is('administrator/subscriptions/customers/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/customers/settings/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/customers/logs/*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.subscriptions.clients.list')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>By Customers</span>
                </a>
            </li>

            <li class="treeview <?php echo e(Request::is('administrator/subscriptions/garages/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/garages/settings/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/subscriptions/garages/logs/*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.subscriptions.garages.list')); ?>">
        ...
        <li class="treeview <?php echo e(Request::is('administrator/transactions/garages/package-subscription') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/transactions/customers/package-subscription') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/transactions/customers/service-request') ? 'active' : ''); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview <?php echo e(Request::is('administrator/transactions/customers/*') ? 'active' : ''); ?>">
              <a href="#">
                <i class="fa fa-circle-o"></i> <span>Customers Transactions</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
                <li class="treeview <?php echo e(Request::is('administrator/transactions/customers/package-subscription') ? 'active' : ''); ?> ">
                    <a href="<?php echo e(route('superadmin.transactions.customers_package_subscription')); ?>">
                        <i class="fa fa-circle-o" aria-hidden="true"></i> <span>By Package Subscription</span>
                    </a>
                </li>

                <li class="treeview <?php echo e(Request::is('administrator/transactions/customers/service-request') ? 'active' : ''); ?>">
                    <a href="<?php echo e(route('superadmin.transactions.customers_service_request')); ?>">
            ...
            <li class="treeview <?php echo e(Request::is('administrator/transactions/garages/package-subscription') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.transactions.garages_package_subscription')); ?>">
        ...
        <li class="treeview <?php echo e(Request::is('administrator/pages/faq/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/faq/add') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/faq/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/about-us') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/terms-conditions') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/privacy-policy') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/contact-us') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/testimonial') ? 'active' : ''); ?>">
          ...
          <ul class="treeview-menu">
             ...
             <li class="treeview <?php echo e(Request::is('administrator/pages/contact-us') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.contactus')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>Contact Us</span>
                </a>
            </li>

             <li class="treeview <?php echo e(Request::is('administrator/pages/about-us') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.aboutus')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>About Us</span>
                </a>
            </li>

             <li class="treeview <?php echo e(Request::is('administrator/pages/terms-conditions') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.termsconditions')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>Terms and conditions</span>
                </a>
            </li>

             <li class="treeview <?php echo e(Request::is('administrator/pages/privacy-policy') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.privacy-policy')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>Privacy Policy</span>
                </a>
            </li>

             <li class="treeview <?php echo e(Request::is('administrator/pages/testimonial/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/testimonial/add') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/testimonial/edit/*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.testimonial')); ?>">
                    <i class="fa fa-circle-o" aria-hidden="true"></i> <span>Testimonials</span>
                </a>
            </li>
           
            <li class="treeview <?php echo e(Request::is('administrator/pages/faq/list') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/faq/add') ? 'active' : ''); ?> <?php echo e(Request::is('administrator/pages/faq/edit/*') ? 'active' : ''); ?>">
                <a href="<?php echo e(route('superadmin.pages.faq')); ?>">
         ...
         <li class="treeview <?php echo e(Request::is('administrator/settings/commissions') ? 'active' : ''); ?>">
          <a href="<?php echo e(route('superadmin.settings.commissions')); ?>">
...
<?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>