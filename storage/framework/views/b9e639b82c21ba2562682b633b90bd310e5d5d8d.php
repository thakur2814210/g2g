    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php if($result['commonContent']['roles']!= null and $result['commonContent']['roles']->manage_admins_view == 1): ?>
         ...
         <li class="treeview <?php echo e(Request::is('administrator/garage/*') ? 'active' : ''); ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('administrator/garage/active/list') ? 'active' : ''); ?> <?php echo e(Request::is('admin/updatevendor') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editvendor/*') ? 'active' : ''); ?>">
              <a href="<?php echo e(route('superadmin.garages.active')); ?>">
                <i class="fa fa-circle-o"></i> Active
              </a>
            </li>

            <li class="<?php echo e(Request::is('administrator/garage/pending/list') ? 'active' : ''); ?> ">
              <a href="<?php echo e(route('superadmin.garages.pending')); ?>">
                <i class="fa fa-circle-o"></i> Pending
              </a>
            </li>

            <li class="<?php echo e(Request::is('administrator/garage/delete/list') ? 'active' : ''); ?> ">
...
<?php /**PATH /home/g2g/public_html/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>