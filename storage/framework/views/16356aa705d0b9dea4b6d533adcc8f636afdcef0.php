...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Add Garage/Vendor</li>
    </ol>
  </section>
                                ...
                                <div class="box box-solid box-primary">
                                    ...
                                    <div class="row">
                                      <div class="col-md-12">
                                          ...
                                          <select class="form-control" name="garage_vendor_type" id="garage_vendor_type">
                                            ...
                                            <option value="1">Garage Only</option>
                                            <option value="2">Shop Vendor Only</option>
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                          <div class="form-group">
                                            <label for="tag_slug" class="col-sm-12 col-form-label">Last Name</label>
                                            <div class="col-sm-12">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Admin_bk/Resources/views/garage/add-garage.blade.php ENDPATH**/ ?>