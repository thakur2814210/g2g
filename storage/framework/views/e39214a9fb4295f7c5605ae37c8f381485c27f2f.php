            ...
            <div class="container">
                <ul class="clearfix row">
                    <li class="col-6 col-md-3 col-lg-2">
                        ...
                        <a href="<?php echo e(route('autoshop.homepage')); ?>" >
...
<?php echo $__env->make('website::layouts.homepage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/Modules/Website/Resources/views/pages/homepage.blade.php ENDPATH**/ ?>