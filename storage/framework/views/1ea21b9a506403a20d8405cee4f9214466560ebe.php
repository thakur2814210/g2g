<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="header"><?php echo e(trans('labels.manage_g2g')); ?></li>
        <br/>

        <li class="header"><?php echo e(trans('labels.manage_autoshop')); ?></li>
...
<?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>