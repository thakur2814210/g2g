    ...
    headers: {'X-CSRF-TOKEN': jQuery('meta[name="csrf-token"]').attr('content')},
		...
		success: function (res) {
			if(res.status == 'exceed'){
				...
				swal("<?php echo app('translator')->get('website.Congrats!'); ?>", "<?php echo app('translator')->get('website.Product Added Successfully Thanks.Continue Shopping'); ?>", "success");
 ...
 jQuery.ajax({
	 ...
	 success: function (res) {
		 if(res['status'] == 'exceed'){
			 ...
			 jQuery('.head-cart-content').html(res);
			 jQuery(parent).addClass('active');
			 swal("<?php echo app('translator')->get('website.Congrats!'); ?>", "<?php echo app('translator')->get('website.Product Added Successfully Thanks.Continue Shopping'); ?>", "success",{button: false});
...
<?php /**PATH D:\xampp74\htdocs\g2g\resources\views/autoshop/common/scripts.blade.php ENDPATH**/ ?>