                      ...
                      <?php if(!empty($serviceRequests) && count($serviceRequests) > 0): ?>
                        <?php $__currentLoopData = $serviceRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                            ...
                            <td><?php echo e($serviceRequest->id); ?></td>
                            <td><?php echo e(date("Y-m-d g:i a", strtotime($serviceRequest->created_at))); ?></td>
                            <td><?php echo e($serviceRequest->sr_code); ?></td>
                            <td><?php echo e($serviceRequest->category->name); ?></td>
                            <td><?php echo e($serviceRequest->client->user['first_name']); ?> <?php echo e($serviceRequest->client->user['last_name']); ?></td>
                            <td><?php echo e($serviceRequest->vehicle->vmake->name); ?><br/>(<?php echo e($serviceRequest->vehicle->vmodel->name); ?>)</td>
                            <td><?php echo e($serviceRequest->garage->defaultGarageDescription[0]->garages_name); ?></td>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Admin/Resources/views/servicerequest/index.blade.php ENDPATH**/ ?>