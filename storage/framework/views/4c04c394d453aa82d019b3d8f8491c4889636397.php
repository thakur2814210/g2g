    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
       <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item">
          <a href="<?php echo e(route('garage.customers.packages-subscribed')); ?>">Customers Packages Subscribed List</a>
        </li>
                    ...
                    <div class="row">
                      <div class="col-md-4">
                         <div class="form-group">
                          ...
                          <p><?php echo e($ps->client->user->first_name); ?> <?php echo e($ps->client->user->last_name); ?></p>
                        </div>
                      </div>
                      <?php if( $ps->status == 1 ): ?> 
                        <div class="col-md-4">
                  ...
                  <div class="row">
                      <div class="col-md-6 ">
                          <div class="form-group">
                              ...
                              <p>
                                  <?php echo e($ps->vip_pickup_opted === 1 ? "Yes" : "No"); ?>
                      ...
                      <div class="col-md-6 ">
                          <div class="form-group">
                              ...
                              <p>                             <?php echo e($ps->vip_pickup_opted === 1 ? 'AED '.$ps->vip_pickup_price : "N/A"); ?>
...
<?php echo $__env->make('garage::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Garage/Resources/views/customer/ps/setting.blade.php ENDPATH**/ ?>