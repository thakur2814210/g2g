                      ...
                      <tbody>
                        <?php if(!empty($serviceRequests) && count($serviceRequests) > 0): ?>
                          <?php $__currentLoopData = $serviceRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $serviceRequest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                              <td><?php echo e(date('Y-m-d', strtotime($serviceRequest->date))); ?></td>
                              <td>AED <?php echo e(number_format($serviceRequest->amount,2)); ?></td>
                              <td>
                                <?php
                              ...
                              <td>
                                   <?php if($serviceRequest->status == 1): ?>
                                      Success
                                    <?php elseif($serviceRequest->status == 2): ?>
                                      Failed
                                    <?php elseif($serviceRequest->status == 3): ?>
                                      Pending
                                    <?php elseif($serviceRequest->status == 4): ?>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/Modules/Admin/Resources/views/transaction/customers_service_request.blade.php ENDPATH**/ ?>