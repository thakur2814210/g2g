...
<?php $__env->startSection('breadcrumb'); ?>
   <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Add Garage</li>
    </ol>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
   ...
   <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header bg-gray">Add New Garage</div>
          ...
          <div class="card-body table-responsive p-0">
              ...
              <form class="form-horizontal" method="POST" action="<?php echo e(route('superadmin.garage.save')); ?>" enctype="multipart/form-data">
                ...
                <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-user text-danger"></i>Create User</h2>
                  </div>
                 ...
                 <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-user text-danger"></i>Create Garage</h2>
                  </div>
             ...
             <?php if(isset($catList['subCats'])): ?>
               <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-tags text-danger"></i> Garage Services</h2>
                  </div>
                   ...
                   <?php $__currentLoopData = $catList['mainCats']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-md-12">
                          <div class="form-check d-inline">
                            <input class="form-check-input" type="checkbox" name="cat_id[]" value="<?php echo e($cat['id']); ?>">
                            <h6 class="form-check-labe">Main Category: <?php echo e($cat['name']); ?></h6>
               ...
               <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-clock-o text-danger"></i>Garage Working Hours</h2>
                  </div>
                  <?php
                    $days = [
                        'mon' => 'Monday',
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          ...
                          <select name="ot_<?php echo e($index); ?>" required>
                      ...
                      <div class="col-md-5">
                        <div class="form-group">
                          <div class="styled-select">
                           <select name="ct_<?php echo e($index); ?>" required>
                            <?php $__currentLoopData = $optionTime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($value); ?>"><?php echo e($value); ?></option> 
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          </select>
              ...
              <div style="clear:both"></div>
               ...
               <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-map-marker text-danger"></i> Garage Location</h2>
                  </div>
              ...
              <div style="clear:both"></div>
               ...
               <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-user-circle text-danger"></i> Garage Owner Information</h2>
                  </div>
              ...
              <div style="clear:both"></div>
               ...
               <div class="box_general padding_bottom">
                  <div class="header_box version_2">
                    <h2  class="text-danger"><i class="fa fa-user-circle text-danger"></i> Admin Section</h2>
                  </div>
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/Modules/Admin/Resources/views/garage/add-garage.blade.php ENDPATH**/ ?>