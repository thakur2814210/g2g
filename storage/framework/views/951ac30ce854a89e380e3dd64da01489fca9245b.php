...
<div class="login-box">
  <div class="login-logo">
    ...
    <div style="
    font-size: 25px;
"><b> <?php echo e(trans('labels.welcome_message')); ?></b><?php echo e(trans('labels.welcome_message_to_vendor')); ?></div>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo Form::open(array('url' =>'vendor/checkLogin', 'method'=>'post', 'class'=>'form-validate')); ?>
...
<?php echo $__env->make('vendor.layoutLlogin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/ishan/g2g-v3/resources/views/vendor/login.blade.php ENDPATH**/ ?>