                        ...
                        <div class="row" style="padding-top: 1%;">
                                ...
                                <div class="card">
                                    <div class="card-header" style="background: #111;">
                                        <span class="card-title text-white"><i
                                                    class="fa fa-money"></i><?php echo app('translator')->get('website.Service Request'); ?>  <?php echo app('translator')->get('website.Payment'); ?> <?php echo app('translator')->get('website.Information'); ?></span>
                                    </div>
                                    <div class="card-body table-responsive">
                                        ...
                                        <?php if($sr->status == 'request-payment'): ?>
                                            ...
                                            <form class="form-horizontal" method="POST"
                                                  action="<?php echo e(route('client.service-request.update-sr-payment-status')); ?>">
                                                <?php echo e(csrf_field()); ?>

                                                <input type="hidden" name="id" value="<?php echo e($sr->id); ?>">
                                                <div class="form-group">
                                                    <h6><?php echo app('translator')->get('website.Quote Amount (AED)'); ?>
                                                        : <?php echo e(number_format($sr->quote_amount,2)); ?></h6>
                                                </div>
                                                <div class="form-group">
                                                    <h6><?php echo app('translator')->get('website.Make'); ?> <?php echo app('translator')->get('website.Payment'); ?></h6>
                                                    <select class="form-control" name="payment_type" id="payment_type">
                                                        <option value="cod"
                                                                selected=""><?php echo app('translator')->get('website.Cash On Delivery'); ?></option>
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-success"
                                                            data-dismiss="modal"><?php echo app('translator')->get('website.Submit'); ?> <?php echo app('translator')->get('website.Payment'); ?></button>
                                                </div>
                                        ...
                                        <?php elseif($sr->status == 'new'): ?>
                                            <p class="btn btn-block btn-outline-danger">
                                                <b>Information:</b><br/> <?php echo app('translator')->get('website.Service request create and waiting for the Garage quote amount'); ?>
                                            </p>
                            ...
                            <div class="col-md-12 col-sm-12 ">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-header" style="background: #111;">
                                        <span class="card-title text-white"><i
                                                    class="fa fas fa-tags"></i> <?php echo app('translator')->get('website.Service Request'); ?> <?php echo app('translator')->get('website.Information'); ?></span>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php if(!empty($sr->image)): ?>
                                            <div class="form-group">
                                                ...
                                                <img src="<?php echo e(asset($sr->image )); ?>"
                                        ...
                                        <?php if(!empty($sr->image1)): ?>
                                            <div class="form-group">
                                                <p class="btn btn-block btn-outline-danger">Images (It's Optional)</p>
                                                <img src="<?php echo e(asset($sr->image1 )); ?>"
                                                     height="200" width="auto"/>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($sr->image2)): ?>
                                            <div class="form-group">
                                                <p class="btn btn-block btn-outline-danger">Images (It's Optional)</p>
                                                <img src="<?php echo e(asset($sr->image2 )); ?>"
                                                     height="200" width="auto"/>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($sr->image3)): ?>
                                            <div class="form-group">
                                                <p class="btn btn-block btn-outline-danger">Images (It's Optional)</p>
                                                <img src="<?php echo e(asset($sr->image3 )); ?>"
                                                     height="200" width="auto"/>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($sr->image4)): ?>
                                            <div class="form-group">
                                                <p class="btn btn-block btn-outline-danger">Images (It's Optional)</p>
                                                <img src="<?php echo e(asset($sr->image4 )); ?>"
                                                     height="200" width="auto"/>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if(!empty($sr->image5)): ?>
                                            <div class="form-group">
                                                <p class="btn btn-block btn-outline-danger">Images (It's Optional)</p>
                                                <img src="<?php echo e(asset($sr->image5 )); ?>"
                                                     height="200" width="auto"/>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p><?php echo e($sr->garage->address); ?>, <?php echo e($sr->garage->city->name); ?>

                                                , <?php echo e($sr->garage->country->name); ?>, <?php echo app('translator')->get('website.Pobox'); ?>
                                                -<?php echo e($sr->garage->postal); ?></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="text-uppercase"><?php echo e(date('Y-m-d h:i a', strtotime($sr->created_at))); ?>
                                        ...
                                        <div class="form-group">
                                            <p class="btn btn-block btn-outline-danger"><?php echo app('translator')->get('website.Pick and drop your car from your location?'); ?></p>
                                            <p>
                                                <?php if($sr->vip_pickup_opted === 1): ?>
                                                    <?php echo app('translator')->get('website.Yes'); ?>, AED <?php echo e($sr->vip_pickup_price); ?> <?php echo app('translator')->get('website.payable in cash'); ?>
                                                <?php else: ?>
...
<?php echo $__env->make('autoshop.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/resources/views/autoshop/service-request/setting.blade.php ENDPATH**/ ?>