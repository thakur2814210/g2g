...
<script src="<?php echo asset('admin/plugins/jquery-repeatable/jquery.repeatable.js'); ?>"></script>
...
$("img").click(function() {
  ...
  $("#btn").click(function() {
	...
	if (confirm('Are You Sure To Delete This?')) {
		...
		if(imgs>0){
			$.ajax({
			url: '<?php echo e(URL::to("partner/media/delete")); ?>',
			type: "POST",
			data: formData,
...
$(document).on('click', '.currentstock', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attach/attribute/default/options/currentstock")); ?>',
		type: "POST",
		data: formData,
		dataType: "json",
		success: function (res) {
...
$(document).on('click','#add-inventory',function(e){
	var formData = $('#addewinventoryfrom').serialize();
	$.ajax({
		url: '<?php echo e(URL::to("partner/addnewstock")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('click', '.add-value', function(e){
	...
	var formData = parentFrom.serialize();
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attributes/options/values/addattributevalue")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '.update-value', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attributes/options/values/updateattributevalue")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#deleteAttribute', function(e){
	...
	var formData = parentFrom.serialize();
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attributes/options/values/delete")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
				$('.addError').hide();
...
$(document).on('click', '#addAttribute', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attach/attribute/default/options/add")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('click', '#addDefaultAttribute', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attach/attribute/default")); ?>',
		type: "POST",
		data: formData,
		success: function (res) {
...
$(document).on('change', '#entry_country_id', function(e){
	...
	$.ajax({
	  url: "<?php echo e(URL::to('partner/getZones')); ?>",
	  dataType: 'json',
	  type: "post",
...
$(document).on('click', '.editproductattributemodal', function(){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attach/attribute/default/options/edit")); ?>',
		type: "POST",
...
$(document).on('click', '.editdefaultattributemodal', function(){
	...
	var options_id = $(this).attr('options_id');
	$.ajax({
		url: "<?php echo e(URL::to('partner/products/attach/attribute/default/edit')); ?>",
		type: "POST",
		data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id+'&language_id='+language_id+'&options_id='+options_id,
		success: function (data) {
...
$(document).on('click', '#updateAddress', function(e){
	...
	$(document).on('click', '#updateProductAttribute', function(e){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/products/attach/attribute/default/options/update")); ?>',
			type: "POST",
			data: formData,
			success: function (res) {
	...
	$(document).on('click', '#updateDefaultAttribute', function(e){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attach/attribute/default/update')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
	...
	// 	$.ajax({
	// 		url: "<?php echo e(URL::to('partner/customers/deleteAddress')); ?>",
	// 		type: "POST",
	// 		data: formData,
	// 		success: function (res) {
	...
	$(document).on('click', '.deleteproductattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attach/attribute/default/options/showdeletemodal')); ?>",
			type: "POST",
			data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id,
			success: function (data) {
				$('.deleteEmbed').html(data);
	...
	$(document).on('click', '.deletedefaultattributemodal', function(){
		...
		var products_attributes_id = $(this).attr('products_attributes_id');
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attach/attribute/default/deletedefaultattributemodal')); ?>",
			type: "POST",
			data: '&products_id='+products_id+'&products_attributes_id='+products_attributes_id,
			success: function (data) {
	...
	$(document).on('click', '.deleteOption', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attributes/options/values/checkattributeassociate')); ?>",
			type: "POST",
	...
	$(document).on('click', '.delete-value', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attributes/options/values/checkvalueassociate')); ?>",
			type: "POST",
	...
	$(document).on('click', '#deleteProductAttribute', function(){
		...
		console.log(formData);
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/attach/attribute/default/delete')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
				//$('.deleteEmbed').html(res);
	...
	$(document).on('click', '#addImage', function(e){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/addnewproductimage")); ?>',
			type: "POST",
			data: formData,
			success: function (res) {
				if(res.length != ''){
	...
	$(document).on('click', '.website_themes', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/updateWebTheme")); ?>',
			type: "POST",
	...
	$(document).on('click', '.editProductImagesModal', function(){
		...
		var products_id = $(this).attr('products_id');
		$.ajax({
			url: '<?php echo e(URL::to("partner/editproductimage")); ?>',
			type: "POST",
	...
	$(document).on('click', '#updateProductImage', function(e){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/updateproductimage')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
				if(res.length != ''){
	...
	$("#sendNotificaionForm").submit(function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/devices/notifyUser')); ?>",
			type: "POST",
			data: formData,
	...
	$(document).on('click', '.deleteProductImagesModal', function(){
		...
		var products_id = $(this).attr('products_id');
		$.ajax({
			url: '<?php echo e(URL::to("partner/products/images/deleteproductimagemodal")); ?>',
			type: "POST",
			data: '&products_id='+products_id+'&id='+id,
			success: function (data) {
	...
	$(document).on('click', '#deleteProductImage', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/products/images/deleteproductimage')); ?>",
			type: "POST",
			data: formData,
			success: function (res) {
				if(res.length != ''){
	...
	$(document).on('click', '#notification-popup', function(){
		var customers_id = $(this).attr('customers_id');
		$.ajax({
			url: '<?php echo e(URL::to("partner/devices/customerNotification")); ?>',
			type: "POST",
	...
	$(document).on('click', '.manage-role-popup', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/managerolepopup")); ?>',
			type: "POST",
			data: '&customers_id='+customers_id,
			success: function (data) {
	...
	$(document).on('focus', '.couponProdcuts input', function(){
		...
		$.ajax({
			url: "<?php echo e(URL::to('partner/couponProducts')); ?>",
			type: "POST",
			data: '',
			success: function (data) {
			},
	...
	$(document).on('click', '#enableWithdrawMethodForm', function(){
		var enable_withdraw_method_id = $(this).attr('enable_withdraw_method_id');
		$('#enable_withdraw_method_id').val(enable_withdraw_method_id);
		$("#enableWithdrawMethodModal").modal('show');
	});

	// Disable withdraw method
	$(document).on('click', '#disableWithdrawMethodForm', function(){
		var disable_withdraw_method_id = $(this).attr('disable_withdraw_method_id');
		$('#disable_withdraw_method_id').val(disable_withdraw_method_id);
		$("#disableWithdrawMethodModal").modal('show');
	});

	// withdraw money form ...
	$(document).on('click', '#WithdrawMoneyForm', function(){
		var withdraw_method_id = $(this).attr('withdraw_method_id');
		$('#withdraw_method_id').val(withdraw_method_id);
		$("#WithdrawMoneyFormModal").modal('show');
	});
  ...
  $(document).on('click', '#deleteModelId', function(){
	...
	$(document).on('click', '.getRange', function(){
		...
		if(dateRange != ''){
			...
			dateRange = dateRange.replace(/ /g , "");
			window.location="<?php echo e(URL::to('partner/dashboard/dateRange=')); ?>"+dateRange;
		}else{
	...
	$(document).on('click', '.default_method', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/defaultShippingMethod")); ?>',
			type: "POST",
	...
	$(document).on('click', '.default_language', function(){
		...
		$.ajax({
			url: '<?php echo e(URL::to("partner/languages/default")); ?>',
			type: "POST",
  ...
  $(document).on('click', '.default_pay_method', function(){
    ...
    $.ajax({
      url: '<?php echo e(URL::to("partner/paymentmethods/active")); ?>',
      type: "POST",
...
// 	$.ajax({
// 		url: '<?php echo e(URL::to("partner/getOptions")); ?>',
// 		type: "POST",
// 		data: '&languages_id='+languages_id,
// 		success: function (data) {
...
function getOptionsValue(option_id) {
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/attach/attribute/default/options/getOptionsValue")); ?>',
		type: "POST",
...
function getSubCategory() {
	...
	<?php if(Request::path() == 'admin/addProduct'): ?>
	 	var getCategories =	'<?php echo e(URL::to("partner/getajaxcategories")); ?>';
...
$(document).on('click', '#generate-key', function(e){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/generateKey")); ?>',
		type: "GET",
		async: false,
		success: function (res) {
			$("#loader").hide();
...
$(document).on('change','.product-type', function(){
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/inventory/ajax_min_max")); ?>'+'/'+product_id,
		type: "GET",
		success: function (res) {
	...
	$.ajax({
		url: '<?php echo e(URL::to("partner/products/inventory/ajax_attr")); ?>'+'/'+product_id,
		type: "GET",
		success: function (res) {
			//console.log(res);
			$('#attribute').html(res);
...
$(document).ready(function(){
    $("#myModaldetail").on("show.bs.modal", function(e) {
        ...
        $.get( "<?php echo e(URL::to('partner/detailimage')); ?>"+'/' + id, function( data ) {
...
$(document).on('click', '.refresh-image', function(e){
	$("#loader").show();
	$.ajax({
		url: '<?php echo e(URL::to("partner/media/refresh")); ?>',
		type: "GET",
		success: function (res) {
...
$(document).on('click', '#check-password', function(e){
	...
	if(password !=''){
		$.ajax({
			url: '<?php echo e(URL::to("partner/managements/checkpassword")); ?>',
			type: "post",
...
<script>
	...
	function check_sr_quote_total() {
		var quotesum = 0;
		$(".sr_quote_amount").each(function(){
			quotesum += +$(this).val();
		});
		$(".sr_quote_total").val(quotesum);
	}

	$(document).ready(function() {
		check_sr_quote_total();
		$(document).on("keyup", ".sr_quote_amount", function() {
			check_sr_quote_total();
		});

		$("form .repeatable-container").repeatable({
			template: "#sr_amounts_json",
			min: 1,
			afterDelete: function () {check_sr_quote_total()}
		});
	});
...
<script type="text/template" id="sr_amounts_json">
<!--	<div class="field-group">
			<label for="amount_json[{?}][particular]">Particular</label>
		<input type="text" name="amount_json[{?}][particular]" value="" id="amount_json[{?}][particular]" />

		<label for="amount_json[{?}][amount]">Amount</label>
		<input type="text" name="amount_json[{?}][amount]" value="" id="amount_json[{?}][amount]" />
	...
	<div class="row field-group">
			...
			<div class="row">
				...
				<div class="col-md-8 col-xs-12">
					<div class="form-group">
						<input class="form-control" type="text" name="amount_json[{?}][particular]" placeholder="Particular" required>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-4 col-xs-4">
			<div class="row">
				...
				<div class="col-md-8 col-xs-12">
					<div class="form-group">
						<input class="form-control sr_quote_amount" type="number" name="amount_json[{?}][amount]" placeholder="Amount (AED)" required>
					</div>
				</div>
			</div>
		</div>
		<div class="col-md-1 col-xs-1 text-right" style="padding: 0">
			<input type="button" class="delete btn btn-danger" value="X" />
		</div>
	</div>
</script>
<?php /**PATH D:\xampp74\htdocs\g2g\resources\views/garage/common/scripts.blade.php ENDPATH**/ ?>