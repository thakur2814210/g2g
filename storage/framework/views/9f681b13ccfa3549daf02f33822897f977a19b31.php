<header class="header_in">
	<div class="container">
		<div class="row">
			<div class="col-lg-2 col-12">
				<div id="logo">
					<a href="<?php echo e(route('page.homepage')); ?>" title="G2G">
						<img src="<?php echo e(asset('website-theme/img/logo/logo-g2g.png')); ?>" height="35" alt="" class="logo_sticky">
					</a>
				</div>
			</div>
			<div class="col-lg-10 col-12">
				<!--ul id="top_menu">
					<li>
						<div class="styled-select mt-1" id="lang-selector">
							<select>
	...
	<!-- /container -->		
</header><?php /**PATH /home/devhs/public_html/g2g-v3/Modules/Website/Resources/views/include/search-header.blade.php ENDPATH**/ ?>