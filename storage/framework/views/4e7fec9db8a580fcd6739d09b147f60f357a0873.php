...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      <li><a href="<?php echo e(route('garage.dashboard')); ?>"><i class="fa fas fa-home"></i> Dashboard</a></li>
       <li>
          <a href="<?php echo e(route('garage.packages')); ?>">My Packages</a>
        </li>
        ...
        <div class="box-body">
         <div class="table-responsive">
           <table class="table table-head-fixed table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                <?php if(!empty($garagePackageSubscribes) && count($garagePackageSubscribes) > 0): ?>
                  <?php $__currentLoopData = $garagePackageSubscribes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $garagePackageSubscribe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      <td><?php echo e($garagePackageSubscribe->created_at); ?></td>
                      <td><?php echo e($garagePackageSubscribe->servicePackage->name); ?></td>
                      <td>AED <?php echo e(number_format($garagePackageSubscribe->amount, 2)); ?></td>
                      <td>
                        <?php if(!empty($garagePackageSubscribe->subscription_start_at)): ?>
                          <?php echo e($garagePackageSubscribe->subscription_start_at); ?>
                      ...
                      <td>
                        <?php if(!empty($garagePackageSubscribe->subscription_end_at)): ?>
                          <?php echo e($garagePackageSubscribe->subscription_end_at); ?>
                      ...
                      <td>
                        <?php echo e($packageStatus[$garagePackageSubscribe->status]); ?>

                      </td>
                      <td>
                        <a class="btn btn-sm btn-outline-danger "  href="<?php echo e(route('garage.packages.settings',['id' =>$garagePackageSubscribe->id])); ?>">
                          Update
                        </a>
                        &nbsp;
                        <a  class="btn btn-sm btn-outline-danger" href="<?php echo e(route('garage.packages.logs',['id' =>$garagePackageSubscribe->id])); ?>">
                          Log
                        </a>
                      </td>
                    </tr>
...
<div class="modal fade" id="cancelSubscribeRequest" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form  method="POST" action="<?php echo e(route('garage.packages.cancel-subscribe-request')); ?>">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header bg-danger">
       ...
       <form  method="POST" action="<?php echo e(route('garage.packages.cancel-subscription')); ?>">
        <div class="modal-body">
            <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('garage.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Garage/Resources/views/package/index.blade.php ENDPATH**/ ?>