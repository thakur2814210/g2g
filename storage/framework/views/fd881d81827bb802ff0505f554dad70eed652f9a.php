          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              <div class=" active tab-pane" id="profile">
                ...
                <?php endif; ?>
                <!-- The timeline -->
                   <?php echo Form::open(array('url' =>'partner/profile/update', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
                      ...
                      <div class="form-group form-group-email">
	                    <label for="email" class="col-sm-2 control-label"><?php echo e(trans('labels.Email')); ?></label>
						          <div class="col-sm-10">
	                      <input type="text" class="form-control" id="email" value="<?php echo e(auth()->user()->email); ?>" name="email" placeholder="email">
                     ...
                     <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              <select class="form-control" name="garage_vendor_type" id="garage_vendor_type">
                                <option <?php if(auth()->user()->garage_vendor_type == 1): ?> selected <?php endif; ?> value="1">Garage Only</option>
                                <option <?php if(auth()->user()->garage_vendor_type == 2): ?> selected <?php endif; ?> value="2">Shop Vendor Only</option>
                                 <option <?php if(auth()->user()->garage_vendor_type == 3): ?> selected <?php endif; ?> value="3" >Both</option>
                              </select>
                            </div>
                      </div>
              ...
              <div class="tab-pane" id="passwordDiv">
                 <?php echo Form::open(array('url' =>'partner/profile/updatepassword', 'onSubmit'=>'return validatePasswordForm()', 'id'=>'updateAdminPassword', 'name'=>'updateAdminPassword' , 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
...
<?php echo $__env->make('garage.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/g2g/public_html/Modules/Garage/Resources/views/profile/view-profile.blade.php ENDPATH**/ ?>