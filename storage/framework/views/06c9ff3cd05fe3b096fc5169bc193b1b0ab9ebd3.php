 ...
 jQuery.ajax({
	 ...
	 success: function (res) {
		 if(res['status'] == 'exceed'){
			 ...
			 jQuery('.head-cart-content').html(res);
			 jQuery(parent).addClass('active');
			 swal("Congrats!", "Product Added Successfully Thanks.Continue Shopping", "success",{button: false});
...
<?php /**PATH D:\xampp74\htdocs\g2g\resources\views/website/common/scripts.blade.php ENDPATH**/ ?>