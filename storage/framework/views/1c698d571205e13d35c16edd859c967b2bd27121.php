...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo e(URL::to('admin/g2g/section/list')); ?>"><i class="fa fa-users"></i> <?php echo e(trans('labels.Manage Sections')); ?></a></li>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo e(trans('labels.Add Vendors')); ?> </h3>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            <?php echo Form::open(array('url' =>'admin/addnewvendor', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>

                           
                            <div class="form-group">
                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.ShopName')); ?> </label>
                                <div class="col-sm-10 col-md-4">
                                  <?php echo Form::text('shop_name',  '', array('class'=>'form-control field-validate', 'id'=>'shop_name')); ?>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <select class="form-control" name="isActive">
                                          ...
                                          <option value="3"><?php echo e(trans('labels.Inactive')); ?></option>
                                          <option value="2"><?php echo e(trans('labels.Pending')); ?></option>
									</select>
                                  <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/resources/views/g2g/sections/section-add.blade.php ENDPATH**/ ?>