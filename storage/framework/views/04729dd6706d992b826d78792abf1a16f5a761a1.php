        ...
        <div class="container">
          ...
          <div class="card ">
            <div class="card-header bg-danger text-white">
              <h5 class="text-white"><?php echo e(trans('website.Custom Package Subscription')); ?></h5>
            </div>
            <div class="card-body">
               <div id="accordion">
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                  <div class="col-12 ">
                                    <div class="form-group">
                                      <div class="col-12 ">
                                        <button type="submit" class="btn btn-success"><i class="fa fa-car" ></i> <?php echo e(trans('website.Update Address')); ?>Update Address</button>
                                        <button type="reset" class="btn btn-danger ml-2"><i class="fa fa-times" ></i> <?php echo e(trans('website.Reset')); ?></button>
                  ...
                  <div class="card">
                    <div class="card-header card-link">
                      <h5 class="text-danger"><span class="badge badge-warning">6</span> <?php echo e(trans('website.Duration')); ?>
                    ...
                    <div id="Fault" class="collapse" data-parent="#accordion">
                      <form id="msform" method="POST" action="<?php echo e(route('client.custom-package.save')); ?>">
                        <?php echo e(csrf_field()); ?>
                          ...
                          <div class="card-body">
                            <div class="form-group">
                              <label for="tag_name" class="col-12 col-form-label"><?php echo e(trans('website.Subscription Duration(No Of Days)')); ?></label>
                               <div class="col-12">
                                <input type="number" class="form-control" name="subscription_duration" id="subscription_duration" placeholder="<?php echo e(trans('website.Enter Duration in days')); ?>"  required=""/>
                              </div>
                            </div>
                          </div> 
                          ...
                          <div class="row justify-content-center">
                            <div class="col-12 text-center">
                               <button type="submit" class="btn btn-success text-uppercase float-right" name="submit" id="submit"> <i class="fa fas fa-save"></i> <?php echo e(trans('website.Subscribe Package')); ?></button>
                            </div>
                          </div>
                        </div>
                      </form>
   ...
   function initialize() {
    ...
    $(document).ready(function (){
      $('select[name="make"]').on('change',function(){
        ...
        $('select[name="model"]').html('<option><?php echo e(trans("website.Please wait")); ?></option>');
...
<script>
  ...
  $('.btn-vehicle-continue').click(function(){
    ...
    if($('input[name="vehicle_id"]:checked').val() == undefined){
        var  alertText = "<?php echo e(trans('website.Select atleast one vehicle')); ?>";
        alert(alertText);
      return;
    }else{
  ...
  $('.btn-service-continue').click(function(){
    ...
    $.ajax({
       type:'POST',
       url:'<?php echo e(route('client.package.garage-list')); ?>',
       data: param,
       success:function(data) {
...
<?php echo $__env->make('website.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp74\htdocs\g2g\Modules/Client\Resources/views/package/custom-package/add-custom-package.blade.php ENDPATH**/ ?>