...
<header class="main-header">
    ...
    <a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>" class="logo">
      ...
      <?php if(Auth()->user()->role_id != 3): ?>
        <span class="logo-mini" style="font-size:12px"><b><?php echo e(trans('labels.AdminDashboard')); ?></b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><?php echo e(trans('labels.AdminDashboard')); ?></b></span>
      <?php else: ?>
...
<?php /**PATH /home/devhs/public_html/g2g-v3/resources/views/admin/common/header.blade.php ENDPATH**/ ?>