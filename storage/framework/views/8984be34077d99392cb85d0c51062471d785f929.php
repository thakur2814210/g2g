                    ...
                    <?php if(!empty($garageTeams) && count($garageTeams) > 0): ?>
                      <?php $__currentLoopData = $garageTeams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $garageTeam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?php echo e(route('superadmin.garage.team.delete',['id' => $garageTeam->id])); ?>">
    ...
    <div class="col-md-12">
      <div class="box box-solid box-primary">
        ...
        <div class="box-body">
            ...
            <div class="row p-3">
                <div class="col-md-12">
                   <form class="form-horizontal" method="POST" action="<?php echo e(route('superadmin.garage.team.update')); ?>" enctype="multipart/form-data">
...
<?php echo $__env->make('admin::layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/apple/Projects/g2g-v3/Modules/Admin/Resources/views/garage/garage_teams.blade.php ENDPATH**/ ?>