        ...
        <div class="container">
          ...
          <div class="card ">
            <div class="card-header bg-danger text-white">
              <h5 class="text-white">{{trans('website.Section')}}: {{ $categories->name }} {{trans('website.Service Request')}}</h5>
            </div>
            <div class="card-body">
               <div id="accordion">
                              ...
                              <div class="row">
                               ...
                               <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                 ...
                                 <div class="col-12 col-md-4">
                                       <div class="form-group">
                                          <label for="tag_slug" class="col-12 col-form-label text-danger">{{trans('website.Registration No(Mulkiya)')}}</label>
                                          <div class="col-12">
                                            <input type="text" class="form-control" name="registration_no" id="registration_no" placeholder="{{trans('website.Enter Registration No(Mulkiya)')}}"  />
                                          </div>
                                        </div>
                                  </div>
                  ...
                  <div class="card">
                    <div class="card-header card-link">
                      <h5 class="text-danger"><span class="badge badge-warning">4</span> {{trans('website.Garages')}}
                        ...
                        <div class="form-group">
                          <p class="text-danger"> {{trans('website.Garage list shown here based on your location and in KM')}} *</p>
                           <select class="form-control col-12 col-md-6" name="garage_distance" id="garage_distance" required="required">
                                <option value="5">5 {{trans('website.KM')}}</option>
                                <option value="10" >10 {{trans('website.KM')}}</option>
                                <option value="20" selected="">20 {{trans('website.KM')}}</option>
                                <option value="30" >30 {{trans('website.KM')}}</option>
                                <option value="40" >40 {{trans('website.KM')}}</option>
                                <option value="50" >50 {{trans('website.KM')}}</option>
                            </select>
                        </div>
                        <div id="garage_list"><p>{{trans('website.Please wait')}}</p></div>
                         <div class="form-card">                 
                          <div class="form-group">
                   ...
                   <div class="card">
                     <div class="card-header card-link">
                      <h5 class="text-danger"><span class="badge badge-warning">5</span> {{trans('website.Information Required')}}
                         <span class="Fault-change-span"></span>
                      </h5>
                    </div>
                    <div id="Fault" class="collapse" data-parent="#accordion">
                      
                      <form id="msform" method="POST" action="{{ route('client.service-request.save-new')}}" enctype="multipart/form-data">
                        {{ csrf_field() }}

                        <input type="hidden" name="cat_id" id="cat_id_hidden" value="{{ $cat_slug }}">
                        ...
                        <div class="card-body">
                          ...
                          <div class="form-group">
                            <label class="text-danger"> {{trans('website.Explain your problem')}} *</label>
                            <textarea class="form-control" name="faults_remarks" id="faults_remarks" placeholder="{{trans('website.Explain your problem')}}" rows="5" required=""></textarea>
                          </div>
                           ...
                           <div class="row">
                            <div class="col-12 col-md-6">
                              <div class="custom-file">
                                ...
                                <label class="custom-file-label" for="customFile" >{{trans('website.Upload images related to your problem 1')}}</label>
                              </div>
                            </div>
                             ...
                             <div class="col-12 col-md-6">
                                <div class="custom-file">
                                  ...
                                  <label class="custom-file-label" for="customFile" >{{trans('website.Upload images related to your problem 2')}}</label>
                                </div>
                            </div>
                          </div>
                          <br/>

                           @if($categories->can_appointment)
                           <div class="form-group">
                             <label for="sel1">{{trans('website.Booking Slot Date&Time')}}:</label>
                              <div class='input-group date'>
                                  <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                  </div>
                                  <input type='text' class="form-control" id='datetimepicker1' name="appointment_at" placeholder="{{trans('website.Select Date and Time')}}" />
                              </div>
                            </div>
                             <br/>
                          @endif
                          ...
                          <div class="row justify-content-center">
                              <div class="col-12 text-center">
                                <h6 class="text-danger">{{trans('website.Once service has been requested it cannot be cancelled after approval of quote')}}</h6>
                                 <button type="submit" class="btn btn-success text-uppercase" name="submit" id="submit"> <i class="fa fas fa-save"></i> {{trans('website.Create Service Request')}}</button>
                              </div>
                           </div>
                        </div>
                      </form>
   ...
   $(document).ready(function ()
    {
            ...
            $('select[name="garage_distance"]').on('change',function(){
                ...
                $.ajax({
                   type:'POST',
                   url:'{{route('client.service-request.garage-list-latlong')}}',
                   data: param,
                   success:function(data) {
...
<script>
 ...
 <script src="{{ asset('website-theme/js/bootstrap-datetimepicker.min.js') }}"></script>
 <script type="text/javascript">
            $(function () {
