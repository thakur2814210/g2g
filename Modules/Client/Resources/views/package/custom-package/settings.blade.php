...
@section('content')
    ...
    <!-- Breadcrumbs-->
      <ol class="breadcrumb padding_bottom">
               ...
               <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                       <label>Vehicle</label>
                      <p>{{ $clientPackageSubscribe->vehicle->name }}
             ...
             <div class="card-header card-header-custom">
              ...
              <div class="card-body table-responsive">
                      @if(!empty($clientPackageSubscribePayment))
                        ...
                        @if(!empty($clientPackageSubscribePayment->date) && !empty($clientPackageSubscribePayment->payment_type))
                            <div class="row text-center">
                              <div class="col-6 ">
                                <div class="form-group">
                        ...
                        @if($clientPackageSubscribe->status == 5)
                          <div class="row p-2">
                            <div class="col-12">
                              <form class="form-horizontal" method="POST" action="{{ route('client.custom-package.update-sr-payment-status')}}">
                                {{ csrf_field() }}
                                  <input type="hidden" name="id" value="{{ $clientPackageSubscribe->id }}">
                                   <input type="hidden" name="amount" value="{{ $clientPackageSubscribe->amount }}">
                                  <div class="form-group">
                                    <h6 >Make Payment(COD mode)</h6>
        ...
        <div class="card">
          <div class="card-header card-header-custom">
            <p class="card-title"><i class="fa fas fa-list"></i> List Of Service Requested</p>               
          </div>
            <div class="card-body">
                    ...
                    <div class="box_general padding_bottom">
                        <div class="row">
                         @foreach($catList['mainCats'] as $cat)
                            <div class="col-12">
                              <label class="text-uppercase"><strong>&nbsp;Main Category: {{ $cat['name'] }}</strong></label>
                            </div> 
