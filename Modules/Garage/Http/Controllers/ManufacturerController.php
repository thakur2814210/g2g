...
class ManufacturerController extends Controller
{
    ...
    public function display()
    {
        ...
        return view("garage.manufacturers.index")->with('manufacturers', $manufacturers)->with('result', $result);
    }
    ...
    public function add(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.manufacturers.add", $title)->with('allimage', $allimage)->with('result', $result);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $allimage = $this->images->getimages();        
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.manufacturers.edit", $title)->with('result', $result)->with('editManufacturer', $editManufacturer)->with('allimage', $allimage);
    }
    ...
    public function filter(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.manufacturers.index", $title)->with('result', $result)->with('manufacturers', $manufacturers)->with('name', $name)->with('param', $param);
    }
