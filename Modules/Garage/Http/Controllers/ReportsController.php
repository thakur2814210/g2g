...
class ReportsController extends Controller
{
    ...
    public function statsCustomers(Request $request)
    {
        ...
        return view("garage.reports.statsCustomers", $title)->with('result', $result);
    ...
    public function statsProductsPurchased(Request $request)
    {
        ...
        return view("garage.reports.statsProductsPurchased", $title)->with('result', $result);
    ...
    public function statsProductsLiked(Request $request)
    {
        ...
        $result['commonContent'] = $myVar->Setting->commonContent();
        return view("garage.reports.statsProductsLiked", $title)->with('result', $result);
    ...
    public function outofstock(Request $request)
    {
        ...
        return view("garage.reports.outofstock", $title)->with('result', $result);
    ...
    public function lowinstock(Request $request)
    {
        ...
        return view("garage.reports.lowinstock", $title)->with('result', $result);
    }
    //productsStock
    public function stockin(Request $request)
    {
        ...
        return view("garage.reports.stockin", $title)->with('result', $result);
