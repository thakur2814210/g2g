...
class CouponsController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        $coupons = Coupon::sortable()
            ->when($vendors_id, function($query) use ($vendors_id){
                    if(!is_null($vendors_id))
                        return $query->where('coupons.vendor_id', $vendors_id);
                })
        ...
        return view("garage.coupons.index", $title)->with('result', $result)->with('coupons', $coupons);
    ...
    public function filter(Request $request)
    {
        ...
        $result['currency'] = $this->myVarSetting->getSetting();
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.coupons.index", $title)->with('result', $result)->with('coupons', $coupons)->with('name', $name)->with('param', $param);
    }
    ...
    public function add(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.coupons.add", $title)->with('result', $result);
    }
    ...
    public function insert(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            if (count($couponInfo) > 0) {
                ...
                return redirect('partner/coupons/add')->with('success', Lang::get("labels.CouponAddedMessage"));
            }
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $result['categories'] = $categories;
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.coupons.edit", $title)->with('result', $result);
    }
