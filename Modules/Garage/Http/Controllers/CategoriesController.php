...
class CategoriesController extends Controller
{
  ...
  public function display(){
    ...
    return view("garage.categories.index",$title)->with('categories', $categories)->with('result', $result);
  }
  ...
  public function filter(Request $request){
    ...
    $result['commonContent'] = $this->Setting->commonContent();
    return view("garage.categories.index", $title)->with('result', $result)->with(['categories'=> $categories, 'name'=> $request->FilterBy, 'param'=> $request->parameter]);
  }
  ...
  public function add(Request $request){
    ...
    $result['commonContent'] = $this->Setting->commonContent();
    return view("garage.categories.add",$title)->with('result', $result)->with('allimage', $allimage);
  }
  ...
  //  dd($editSubCategory[0]->parent_id);
    ...
    $result['categories'] = $option;
    $result['commonContent'] = $this->Setting->commonContent();
    return view("garage.categories.edit",$title)->with('result', $result)->with('allimage', $allimage);
   }
