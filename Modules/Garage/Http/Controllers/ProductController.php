...
class ProductController extends Controller
{
    ...
    public function reviews(Request $request)
    {
        ...
        return view("garage.reviews.index", $title)->with('result', $result);
    ...
    public function display(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.index", $title)->with('result', $result)->with('results', $results)->with('categories_id', $categories_id)->with('product', $product);
    ...
    public function add(Request $request)
    {
        ...
        $result['vendors'] = DB::table('garages')
                            ...
                            ->select('garages.user_id','garages_description.garages_name as name' )
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.add", $title)->with('result', $result)->with('allimage', $allimage);
    ...
    public function edit(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.edit", $title)->with('result', $result)->with('allimage', $allimage);
    ...
    public function update(Request $request)
    {
        ...
        if ($request->products_type == 1) {
            return redirect('partner/products/attach/attribute/display/' . $products_id);
        } else {
            return redirect('partner/products/images/display/' . $products_id);
        }
    }
    ...
    public function addinventory(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.inventory.add", $title)->with('result', $result);
    ...
    public function ajax_attr($id)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.inventory.attribute_div")->with('result', $result);
    ...
    public function addinventoryfromsidebar(Request $request)
    {
        ...
        //dd($result);
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.inventory.add1", $title)->with('result', $result);
    ...
    public function displayProductImages(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products/images/index", $title)->with('result', $result)->with('products_id', $products_id);
    ...
    public function addProductImages($products_id)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view('garage.products.images.add', $title)->with('result', $result)->with('products_id', $products_id)->with('allimage', $allimage);
    ...
    public function editProductImages($id)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/images/edit")->with('products_images', $products_images)->with('allimage', $allimage);
    ...
    public function deleteproductimagemodal(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/images/modal/delete")->with('result', $result);
    ...
    public function addproductattribute(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products.attribute.add", $title)->with('result', $result);
    }
    ...
    public function editdefaultattribute(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/pop_up_forms/editdefaultattributeform")->with('result', $result);
    }
    ...
    public function deletedefaultattributemodal(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/modals/deletedefaultattributemodal")->with('result', $result);
    ...
    public function editoptionform(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/pop_up_forms/editproductattributeoptionform")->with('result', $result);
    ...
    public function showdeletemodal(Request $request)
    {
        ...
        $result['data'] = array('products_id' => $products_id, 'products_attributes_id' => $products_attributes_id);
        $result['commonContent'] = $this->Setting->commonContent();
        return view("partner/products/modals/deleteproductattributemodal")->with('result', $result);
