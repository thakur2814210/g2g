...
class ProductAttributesController extends Controller
{
    ...
    public function display(Request $request)
    {
        ...
        return view("garage.products_attributes.index", $title)->with('result', $result);
    }
    ...
    public function add(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products_attributes.add", $title)->with('result', $result);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products_attributes.edit", $title)->with('result', $result);
    ...
    public function displayoptionsvalues(Request $request)
    {
        ...
        return view("garage.products_attributes.options.index", $title)->with('result', $data);
    ...
    public function editoptionsvalues(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products_attributes.options.edit", $title)->with('result', $result);
    }
    ...
    public function addattributevalue(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.products_attributes.options.attributesTable")->with('attributes', $attributes)->with('result', $result);
    }
    ...
    public function updateattributevalue(Request $request)
    {
        ...
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.attributesTable")->with('attributes', $attributes)->with('result', $result);
    }
