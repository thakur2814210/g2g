...
class MediaController extends Controller
{
    ...
    public function refresh()
    {
        ...
        return view("garage.media.loadimages")->with('allimage', $allimage);
    }

    public function display()
    {
        $result['commonContent'] = $this->Setting->commonContent();
        return view("garage.media.index")->with('result', $result);
    }
    ...
    {
        $Images = new Images();
        $images = $Images->getVendorimages();
        $result['commonContent'] = $this->Setting->commonContent();

        return view('garage.media.addimages')->with('images', $images)->with('result', $result);
    }
