		...
		<div class="hero_in shop_detail" style="background: url({{asset( $garage->profile_image)}}) center center no-repeat;background-size: cover;">
			<div class="wrapper">
				<span class="magnific-gallery">
					<a href="{{ asset($garage->profile_image)}}" class="btn_photos" title="Photo title" data-effect="mfp-zoom-in">View photos</a>
					...
					<div class="col-lg-8">
						<section id="description">
							<div class="detail_title_1">
								<h1>{{ $garage->name }}</h1>
								{{ $garage->address }}, {{ $allCities[$garage->city_id]['name'] }}, {{ $countries[$garage->country_id]['name'] }}, {{ $garage->postal }}      
							</div>
							...
							<div class="row">
								...
								<div class="opening add_bottom_30">
	                                ...
	                                <div class="row">
	                                	<div class="col-md-6">
	                                        <ul>
	                                            <li>Monday <span>{{ $garageworkingHours->mon }}</span></li>
	                                            <li>Tuesday <span>{{ $garageworkingHours->tue }}</span></li>
	                                            <li>Wednesday <span>{{ $garageworkingHours->wed }}</span></li>
	                                            <li>Thursday <span>{{ $garageworkingHours->thu }}</span></li>
	                                        </ul>
	                                    </div>
	                                    <div class="col-md-6">
	                                        <ul>
	                                            <li>Friday <span>{{ $garageworkingHours->fri }}</span></li>
	                                            <li>Saturday <span>{{ $garageworkingHours->sat }}</span></li>
	                                            <li>Sunday <span>{{ $garageworkingHours->sun }}</span></li>
	                                        </ul>
	                                    </div>
	                                </div>
	                            </div>
	                            <!-- /opening -->
                           		...
                           		@if(!is_null($garageimages->toArray()))
									<div class="main_title_2">
								...
								@if(!is_null($garageVideos->toArray()))
									<div class="main_title_2">
							...
							<div class="main_title_2">
								<span><em></em></span>
								<h2>Location</h2>
								<p>{{ $garage->address }}, {{ $allCities[$garage->city_id]['name'] }}, {{ $countries[$garage->country_id]['name'] }}, {{ $garage->postal }} </p>
							</div>
...
@section('website_js')
    ...
    <script src="{{ asset('website-theme/js/map_single_shop.js') }}"></script>
    <script src="{{ asset('website-theme/js/infobox.js') }}"></script>
