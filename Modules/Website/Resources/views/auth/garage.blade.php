					...
					<div class="card">
			          <div class="card-header p-0 text-center" style="padding:0px;">
			            <ul class="nav nav-tabs" id="pills-tab" role="tablist">
						  <li class="nav-item">
						    <a class="nav-link active" id="pills-signin-tab" data-toggle="pill" href="#pills-signin" role="tab" aria-controls="pills-signin" aria-selected="true"><i class="fa fas fa-sign-in"></i> @lang('website::default.garage') @lang('website::default.sign_in')</a>
						  </li>
						  <li class="nav-item">
						    <a class="nav-link" id="pills-register-tab" data-toggle="pill" href="#pills-register" role="tab" aria-controls="pills-register" aria-selected="false"><i class="fa fas fa-registered"></i> @lang('website::default.garage') @lang('website::default.register')</a>
						  </li>
						</ul>
			          </div>
						...
						<div class="tab-content" id="pills-tabContent">
							...
							<div class="tab-pane fade show active" id="pills-signin" role="tabpanel" aria-labelledby="pills-signin-tab">
								...
								<div class="box_account">
									...
									<form action="{{ route('garage.authenticate') }}" method="post">
				                    	{{ csrf_field() }}
							...
							<div class="tab-pane fade" id="pills-register" role="tabpanel" aria-labelledby="pills-register-tab">
								<div class="box_account">
									...
									<div class="form_container">
										...
										<form action="{{ route('garage.register') }}" method="post">
											{{ csrf_field() }}
											<div class="form-group">
											...
											<div class="row ">
												...
												<div class="col-9">
													<div class="form-group">
														<input type="number" class="form-control" name="phone" id="phone" max="8" min="8" value="" placeholder="* @lang('website::default.enter_phone')" value="{{Request::old('phone')}}" required="">
													</div>
												</div>
											</div>

											<div class="form-group">
												<input type="text" class="form-control" name="name" id="name" value="" placeholder="* @lang('website::default.garage_name')" value="{{Request::old('garage_name')}}" required="">
											</div>
											 ...
											 <div class="form-group">
								               <div class="card shadow">
								                        <div class="card-body">
															...
															<div class="form-group">
																  <input type="number" class="form-control" name="postal" placeholder="* @lang('website::default.enter_postal')" required="" />
															</div>
								                        </div>
								                    </div>
								              </div>
