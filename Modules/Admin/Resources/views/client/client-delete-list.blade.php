...
@section('breadcrumb')
   <ol class="breadcrumb">
       <li class="breadcrumb-item">
        ...
        <li class="breadcrumb-item active">Delete Customers List</li>
    </ol>
@stop
    ...
    <div class="row">
     ...
     <div class="box_general padding_bottom">
        <div class="header_box version_2">
          <h2  class="text-danger"><i class="fa fa-users text-danger"></i> Delete Customers List</h2>
          <a href="{{ route('superadmin.client.add') }}" class="float-right">  
            <button type="button" class="btn btn-danger"><i class="fa fa-fw fa-plus"></i>Add Customer</button>
          </a>
        </div>
            ...
            @if(!empty($clients) && count($clients) > 0)
              @foreach($clients as $client)
                <tr>
                  ...
                  <td>{{ $client->phone }}</td>
                  <td>
                       <a href="{{ route('superadmin.client.details',['action' => 'edit','id' => $client->id])}}" title="edit configuration">
