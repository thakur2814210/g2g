    ...
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
       <li class="breadcrumb-item">
         ...
         <li class="breadcrumb-item">
            <a href="{{ route('superadmin.garages.pending') }}">Pending Garage/Vendor</a>
        </li>
        <li class="breadcrumb-item">
            <a href="{{ route('superadmin.garages.delete') }}">Delete Garage/Vendor</a>
        </li>
        
      <li class="active">Garage/Vendor Detail</li>
    </ol>
  </section>
                 ...
                 <ul class="nav table-nav pull-right">
                    <li class="dropdown btn-danger">
                        <a class="dropdown-toggle btn-danger" data-toggle="dropdown" href="#">
                            Edit Garage/Vendor <span class="caret"></span>
                        </a>
                        ...
                        <div class="box box-info">
                          ...
                          <div class="row">
                            ...
                            <div class="box-body">
                              ...
                              <form class="form-horizontal" method="POST" action="{{ route('superadmin.garage.update')}}"  enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                   ...
                                   <div class="box box-solid box-primary">
                                    <div class="box-header">
                                        <i class="fa fa-user-circle" ></i>  Garage/Vendor details
                                    </div>
                                    <div class="box-body">

                                       <div class="row">
                                      <div class="col-md-12">
                                          <label class=""><b>Please Select Type...</b></label>
                                          <select class="form-control" name="garage_vendor_type" id="garage_vendor_type">
                                            <option value="">Please Choose</option>
                                            <option value="1" @if($garage->type == 1) selected @endif>Garage Only</option>
                                            <option value="2" @if($garage->type == 2) selected @endif>Shop Vendor Only</option>
                                             <option value="3" @if($garage->type == 3) selected @endif>Both</option>
                                          </select>
                                        </div>
                                    </div>
                                    <br/>
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                              <select class="form-control" name="status" id="status" required="required">
                                                    <option value="1" @if( $garage->status == 1) selected @endif >Approved</option>
                                                    <option value="2" @if( $garage->status == 2) selected @endif>Delete</option>
                                                    <option value="3" @if( $garage->status == 3) selected @endif>Pending</option>
                                                </select>
                                            </div>
                                          </div>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                              <select class="form-control" name="is_feature" id="is_feature" required="required">
                                                  <option value="1" @if( $garage->is_feature == 1) selected @endif >Yes</option>
                                                  <option value="2" @if( $garage->is_feature == 2) selected @endif>No</option>
                                              </select>
                                            </div>
                                          </div>
                                    </div>
