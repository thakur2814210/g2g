                    ...
                    @if(!empty($garageTeams) && count($garageTeams) > 0)
                      @foreach($garageTeams as $garageTeam)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('superadmin.garage.team.delete',['id' => $garageTeam->id]) }}">
    ...
    <div class="col-md-12">
      <div class="box box-solid box-primary">
        ...
        <div class="box-body">
            ...
            <div class="row p-3">
                <div class="col-md-12">
                   <form class="form-horizontal" method="POST" action="{{ route('superadmin.garage.team.update')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
