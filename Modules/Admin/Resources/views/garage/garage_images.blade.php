      ...
      <div class="box box-solid box-primary">
        ...
        <div class="box-body">
            ...
            <div class="row">
                    ...
                    @if(!empty($garageimages) && count($garageimages) > 0)
                      @foreach($garageimages as $garageimage)
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('superadmin.garage.image.delete',['id' => $garageimage->id]) }}">
                ...
                <div class="col-md-4">
                   <form class="form-horizontal" method="POST" action="{{ route('superadmin.garage.image.update')}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
