          ...
          <div class="col-md-12">
            <div class="box box-solid box-info">
              ...
              <div class="box-body">
                ...
                <form class="form-horizontal" method="POST" action="{{ route('superadmin.pages.testimonial.update')}}" enctype="multipart/form-data">
                   {{ csrf_field() }}
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <input type="text" class="form-control" name="name_en" id="name_en" value="{{ $testimonials->name_en }}" required="required" />
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <input type="text" class="form-control" name="designation_en" id="designation_en" value="{{ $testimonials->designation_en }}" />
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-12">
                            <textarea class="form-control faq_textarea" rows="5" name="remarks_en" id="remarks_en" required="required" >{{ $testimonials->remarks_en }}</textarea>
                          </div>
                        </div>
                      </div>
                       ...
                       <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input type="text" class="form-control" name="name_ar" id="name_ar" value="{{ $testimonials->name_ar }}" required="required" />
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input type="text" class="form-control" name="designation_ar" id="designation_ar" value="{{ $testimonials->designation_ar }}" />
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <textarea class="form-control faq_textarea" rows="5" name="remarks_ar" id="remarks_ar" required="required" >{{ $testimonials->remarks_ar }}</textarea>
                            </div>
                          </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                         ...
                         <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <select class="form-control" name="status" id="status" required="required">
                                  ...
                                  <option value="2" @if($testimonials->status == 2) selected @endif>Unpublished</option>
                              </select>
                            </div>
                          </div>
                      </div>
                      <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <div class="col-md-12">
                              <input type="number" class="form-control" name="ordering" id="ordering" value="{{ $testimonials->ordering }}"/>
                            </div>
                          </div>
                      </div>
                    </div>
