                      ...
                      @if(!empty($subscriptions) && count($subscriptions) > 0)
                        @foreach($subscriptions as $subscription)
                          <tr>
                              ...
                              <td>
                                 <a class="btn btn-sm btn-outline-danger "  href="{{route('superadmin.subscriptions.garages.settings',['id' => $subscription->id])}}">
                                    Update
                                  </a>
                                  &nbsp;
                                  <a  class="btn btn-sm btn-outline-danger" href="{{route('superadmin.subscriptions.garages.logs',['id' => $subscription->id])}}">
                                    Logs
                                  </a>
                              </td>
                          </tr>
