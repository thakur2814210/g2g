...
class NewsController extends Controller
{
	...
	public function news(Request $request){
		...
		return view("autoshop.news", ['title' => $title,'final_theme' => $final_theme])->with('result', $result);
	...
	public function newsdetail(Request $request){
		...
		return view("autoshop.news-detail", ['title' => $title,'final_theme' => $final_theme])->with('result', $result);
	}
