...
class CustomerController extends Controller
{
    ...
    public function index(){
        ...
        $sr_customer_count = ServiceRequest::where('client_id', Auth::user()->id)
                                    ->get();
        $ps_customer_count = ClientPackageSubscribe::where('client_id', Auth::user()->id)
                                    ->get();
    ...
    public function addNewLocations(Request $request){
        ...
        if(!empty($client)){
            ...
            $clientLocation->client_id = Auth::user()->id;
