...
class Products extends Model
{
	...
	public function paginator($request){
        ...
        $vendors_id = $myVarsetting->getVendorsId();
        ...
        if($vendors_id != -1){
          $data->where('products.vendors_id', $vendors_id);
        }
  ...
  public function insert($request){
    ...
    $products_id = DB::table('products')->insertGetId([
        ...
        'vendors_id' => !empty($request->vendors_id) ? $request->vendors_id : null,
  ...
  public function addinventoryfromsidebar(){
    ...
    $product = DB::table('products')
                ...
                ->where('products_description.language_id', '=', $language_id);
    if($vendors_id != -1)
      $product->where('products.vendors_id', '=', $vendors_id);
