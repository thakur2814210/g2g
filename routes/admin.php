...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::group(['namespace' => 'AdminControllers', 'middleware' => 'auth', 'prefix' => 'admin'], function () {
        ...
        Route::get('/dashboard/{reportBase}', 'AdminController@dashboard')->name('superadmin.dashboard');
...
//units
        ...
        //vendor managements
        /*Route::get('/vendors/{type}', 'VendorsController@vendors')->middleware('view_manage_admin');
         Route::get('/addvendors', 'VendorsController@addvendors')->middleware('add_manage_admin');
        Route::post('/addnewvendor', 'VendorsController@addnewvendor')->middleware('add_manage_admin');
        Route::get('/editvendor/{id}', 'VendorsController@editvendor')->middleware('edit_manage_admin');
        Route::post('/updatevendor', 'VendorsController@updatevendor')->middleware('edit_manage_admin');
        Route::post('/deletevendor', 'VendorsController@deletevendor')->middleware('delete_manage_admin');*/
    ...
    Route::group(['prefix' => 'admin/transactions', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
    ...
    Route::group(['prefix' => 'admin/vendor/transactions', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
    ...
    Route::group(['prefix' => 'vendor', 'namespace' => 'AdminControllers'], function () {
        
        Route::get('/sign-up', 'VendorsController@doSignUp');
        Route::get('/forget-password', 'VendorsController@forgetPassword');
        Route::post('/processPassword', 'VendorsController@processPassword');
        Route::post('/signupProcess', 'VendorsController@signupProcess');
     });
